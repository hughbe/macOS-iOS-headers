...
- (void)flushMetricsWithReply:(void *)arg1; // needs 1 arg types, found 6: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
...
- (void)purchaseWithRequest:(void *)arg1 reply:(void *)arg2; // needs 2 arg types, found 9: BLPurchaseRequest *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSString *, BLPurchaseResponse *, NSError *, void*

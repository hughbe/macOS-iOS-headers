...
- (void)showHowToWithTitle:(NSString *)arg1 subtitle:(NSString *)arg2 imageIdentifier:(NSString *)arg3 primaryButtonTitle:(NSString *)arg4 primaryButtonEvent:(unsigned long long)arg5 secondaryButtonTitle:(NSString *)arg6 secondaryButtonEvent:(unsigned long long)arg7 animated:(bool)arg8;

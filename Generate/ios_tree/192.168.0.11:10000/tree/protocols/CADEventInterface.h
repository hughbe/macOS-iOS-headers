...
- (void)CADDatabaseGetOrCreateBirthdayCalendar:(void *)arg1; // needs 1 arg types, found 7: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, int, int, void*
- (void)CADDatabaseGetOrCreateSubscribedCalendarsSource:(void *)arg1; // needs 1 arg types, found 7: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, int, NSNumber *, void*
- (void)CADDatabaseGetSecurityScopedLocalURLWrapperForAttachment:(void *)arg1 reply:(void *)arg2; // needs 2 arg types, found 8: CADObjectID *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, int, NSSecurityScopedURLWrapper *, void*
...
- (void)CADOccurrenceCacheGetOccurrenceDateOfEventWithRowID:(void *)arg1 nearestDate:(void *)arg2 prefersForwardSearch:(void *)arg3 reply:(void *)arg4; // needs 4 arg types, found 10: int, NSDate *, bool, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, int, NSDate *, void*

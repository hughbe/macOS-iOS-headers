...
- (void)performEditingTransactionForTextStorage:(void *)arg1 withBlock:(void *)arg2; // needs 2 arg types, found 6: NSTextStorage *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, void*

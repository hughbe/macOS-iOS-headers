...
- (<BWAdaptiveBracketingParameters> *)adaptiveBracketingParametersForDigitalFlashMode:(int)arg1 frameStatistics:(BWFrameStatistics *)arg2 stationary:(bool)arg3 detectedObjects:(NSDictionary *)arg4;

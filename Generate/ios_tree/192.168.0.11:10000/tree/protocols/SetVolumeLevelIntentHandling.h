...
- (void)handleSetVolumeLevel:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 7: SetVolumeLevelIntent *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, SetVolumeLevelIntentResponse *, void*
- (void)resolveDeviceForSetVolumeLevel:(void *)arg1 withCompletion:(void *)arg2; // needs 2 arg types, found 7: SetVolumeLevelIntent *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, SetVolumeLevelDeviceResolutionResult *, void*
- (void)resolveDeviceForSetVolumeLevel:(void *)arg1 withCompletion:(void *)arg2; // needs 2 arg types, found 7: SetVolumeLevelIntent *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, SetVolumeLevelDeviceResolutionResult *, void*

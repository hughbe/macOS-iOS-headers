...
- (void)_itemWithIdentifier:(void *)arg1 forClientBundleID:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 9: <BCSItemIdentifying> *, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, BCSItem *, NSError *, void*

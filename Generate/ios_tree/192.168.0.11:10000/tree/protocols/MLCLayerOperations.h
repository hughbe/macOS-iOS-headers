...
- (NSArray *)compareLayerWithPredicate:(int)arg1;
...
- (NSArray *)instanceNormalizationLayerWithChannelCount:(unsigned long long)arg1 beta:(MLCTensor *)arg2 gamma:(MLCTensor *)arg3 varianceEpsilon:(float)arg4 momentum:(float)arg5;
- (NSArray *)layerNormalizationLayerWithNormalizedShape:(NSArray *)arg1 beta:(MLCTensor *)arg2 gamma:(MLCTensor *)arg3 varianceEpsilon:(float)arg4;
...
- (NSArray *)reductionLayerWithReduceType:(int)arg1 dimension:(unsigned long long)arg2 sourceShapeCount:(unsigned long long)arg3;
- (NSArray *)reshapeLayerWithShape:(NSArray *)arg1;
- (NSArray *)softmaxLayerWithOperation:(int)arg1 dimension:(unsigned long long)arg2;
...
- (NSArray *)fusedFullyConnectedAndSoftmaxLayerWithDescriptor:(MLCConvolutionDescriptor *)arg1 weights:(MLCTensor *)arg2 biasTerms:(MLCTensor *)arg3;
...
- (NSArray *)fusedInstanceNormalizationAndNeuronLayerWithDescriptor:(MLCActivationDescriptor *)arg1 numOfFeatureChannels:(unsigned long long)arg2 beta:(MLCTensor *)arg3 gamma:(MLCTensor *)arg4 varianceEpsilon:(float)arg5 momentum:(float)arg6;

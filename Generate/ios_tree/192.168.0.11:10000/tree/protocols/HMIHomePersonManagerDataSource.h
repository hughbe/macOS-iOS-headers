...
- (void)associateFaceCropsWithUUIDs:(void *)arg1 toPersonWithUUID:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 8: NSSet *, NSUUID *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*

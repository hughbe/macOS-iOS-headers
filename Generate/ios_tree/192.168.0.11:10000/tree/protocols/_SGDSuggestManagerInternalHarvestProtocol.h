...
- (void)deleteSpotlightReferencesWithBundleIdentifier:(void *)arg1 domainIdentifiers:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 8: NSString *, _PASDomainSelection *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, SGXPCResponse *, void*

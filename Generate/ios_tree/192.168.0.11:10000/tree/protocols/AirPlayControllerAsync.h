...
- (void)getProperty:(void *)arg1 qualifier:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 9: NSString *, id, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, int, id, void*

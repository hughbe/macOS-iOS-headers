...
- (void)_dispatchFailedDownloadTaskForResource:(id)arg1 intent:(unsigned long long)arg2 proposedTaskIdentifier:(id)arg3 withError:(id)arg4 withCompletionHandler:(id /* block */)arg5;

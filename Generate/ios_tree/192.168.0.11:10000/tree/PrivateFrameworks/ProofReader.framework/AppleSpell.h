...
- (id)_accentCorrectionResultForString:(id)arg1 range:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2 inString:(id)arg3 offset:(unsigned long long)arg4 language:(id)arg5 onlyAtInsertionPoint:(bool)arg6 capitalize:(bool)arg7 keyEventArray:(id)arg8 selectedRangeValue:(id)arg9;
- (bool)_acceptWithoutAccentForString:(id)arg1 range:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2 inString:(id)arg3 language:(id)arg4;
...
- (unsigned long long)_contextLengthForRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 language:(id)arg2 tagger:(id)arg3 taggerIndex:(unsigned long long)arg4 languageModel:(id)arg5 maxContextLength:(unsigned long long)arg6 context:(unsigned int*)arg7 cleanOffset:(unsigned long long*)arg8 lastTokenRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; }*)arg9 lastTokenID:(unsigned int*)arg10;
...
- (id)_spellServer:(id)arg1 suggestGuessesForWordRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2 inString:(id)arg3 inLanguage:(id)arg4 options:(id)arg5 tagger:(id)arg6 taggerIndex:(unsigned long long)arg7 errorModel:(id)arg8 guessesDictionaries:(id)arg9;
- (id)_standardizedLanguageModelStringForString:(id)arg1;
- (id)_stringForTokenIDs:(const unsigned int*)arg1 tokenCount:(unsigned long long)arg2 entryString:(id)arg3 languageModel:(id)arg4 language:(id)arg5 connection:(struct _PR_DB_IO { unsigned char x1; unsigned char x2; struct _PR_DOC_FORMAT { unsigned char x_3_1_1; unsigned char x_3_1_2; unsigned char x_3_1_3; unsigned char x_3_1_4; unsigned char x_3_1_5; unsigned char x_3_1_6; unsigned short x_3_1_7; unsigned short x_3_1_8; } x3; unsigned short x4; unsigned short x5; unsigned int *x6; unsigned char x7; short x8; short x9; short x10; short x11; unsigned short x12; struct _PR_DBINIT { struct _PR_FILE {} *x_13_1_1[1]; struct _PR_FILE {} *x_13_1_2; struct _PR_FILE {} *x_13_1_3; struct _PR_FILE {} *x_13_1_4; struct _PR_FILE {} *x_13_1_5; } x13; struct _RULEFILE {} *x14[1]; struct _PR_STATUS { unsigned int x_15_1_1; int x_15_1_2; unsigned short x_15_1_3; } x15; }*)arg6 sender:(id)arg7 encoding:(unsigned int)arg8 prefix:(id)arg9 capitalized:(bool)arg10;
...
- (unsigned long long)acceptabilityOfWordBuffer:(char *)arg1 length:(unsigned long long)arg2 language:(id)arg3 encoding:(unsigned int)arg4 forPrediction:(bool)arg5 alreadyCapitalized:(bool)arg6;
- (unsigned long long)acceptabilityOfWordBuffer:(char *)arg1 length:(unsigned long long)arg2 language:(id)arg3 encoding:(unsigned int)arg4 forPrediction:(bool)arg5 alreadyCapitalized:(bool)arg6 depth:(unsigned long long)arg7;
...
- (bool)checkNegativeWordBuffer:(char *)arg1 length:(unsigned long long)arg2 language:(id)arg3 encoding:(unsigned int)arg4 alreadyCapitalized:(bool)arg5;

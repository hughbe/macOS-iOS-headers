...
+ (id)inputScoresForPredictionItem:(const struct ATXPredictionItem { id x1; unsigned long long x2; float x3[807]; float x4; bool x5; bool x6; }*)arg1;
...
+ (id)sharedInstance;
+ (void)updateConfidenceForItem:(struct ATXPredictionItem { id x1; unsigned long long x2; float x3[807]; float x4; bool x5; bool x6; }*)arg1 subscores:(id)arg2;
...
- (void)_copyValidScoreInputsFromPredictionItem:(const struct ATXPredictionItem { id x1; unsigned long long x2; float x3[807]; float x4; bool x5; bool x6; }*)arg1 toPredictionItem:(struct ATXPredictionItem { id x1; unsigned long long x2; float x3[807]; float x4; bool x5; bool x6; }*)arg2;
...
- (double)_predictionScoreAndUpdateConfidenceForItem:(struct ATXPredictionItem { id x1; unsigned long long x2; float x3[807]; float x4; bool x5; bool x6; }*)arg1 interpreter:(id)arg2 consumerSubType:(unsigned char)arg3 scoreLogger:(id)arg4 intentType:(id)arg5;
...
- (double)predictionScoreAndUpdateConfidenceForItem:(struct ATXPredictionItem { id x1; unsigned long long x2; float x3[807]; float x4; bool x5; bool x6; }*)arg1 consumerSubType:(unsigned char)arg2;

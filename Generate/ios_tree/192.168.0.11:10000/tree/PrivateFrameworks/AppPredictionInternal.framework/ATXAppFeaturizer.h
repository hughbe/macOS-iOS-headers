...
- (void)setDistributionBasedScoreInputsForItem:(struct ATXPredictionItem { id x1; unsigned long long x2; float x3[807]; float x4; bool x5; bool x6; }*)arg1 withGeoHashResolution:(unsigned long long)arg2 withGeoHashLaunchCounts:(id)arg3;
- (void)setDistributionBasedScoreInputsForTimeAndDay:(struct ATXPredictionItem { id x1; unsigned long long x2; float x3[807]; float x4; bool x5; bool x6; }*)arg1 forBundleId:(id)arg2 withTimeOfDayHistogram:(id)arg3 withDayOfWeekHistogram:(id)arg4;

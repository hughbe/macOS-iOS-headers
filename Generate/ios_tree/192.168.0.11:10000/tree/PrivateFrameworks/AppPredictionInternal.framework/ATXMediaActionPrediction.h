...
+ (id)updatePlayMediaActionPredictions:(id)arg1 withUpcomingMedia:(id)arg2 forActionKey:(id)arg3 appActionPredictionItem:(const struct ATXPredictionItem { id x1; unsigned long long x2; float x3[807]; float x4; bool x5; bool x6; }*)arg4 appActionLogProbability:(double)arg5 statistics:(id)arg6;

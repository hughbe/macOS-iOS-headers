...
- (void)initializeCloudKitClientWithCompletionHandler:(id /* block */)arg1;
- (bool)isManatee;
- (void)isManateeAvailableWithCompletionHandler:(id /* block */)arg1;
- (void)restoreFromBackupIfNeccessary:(id /* block */)arg1;
- (void)restoreFromBackupWithRetries:(unsigned long long)arg1 completionHandler:(id /* block */)arg2;

...
+ (void)setDistributionBasedScoreInputsForDayOfWeekForItem:(struct ATXPredictionItem { id x1; unsigned long long x2; float x3[807]; float x4; bool x5; bool x6; }*)arg1 withLaunchDistribution:(id)arg2;
+ (void)setDistributionBasedScoreInputsForItem:(struct ATXPredictionItem { id x1; unsigned long long x2; float x3[807]; float x4; bool x5; bool x6; }*)arg1 withGeoHashResolution:(unsigned long long)arg2 withLaunchCounts:(id)arg3;
+ (void)setDistributionBasedScoreInputsForTimeOfDayForItem:(struct ATXPredictionItem { id x1; unsigned long long x2; float x3[807]; float x4; bool x5; bool x6; }*)arg1 withLaunchDistribution:(id)arg2;
+ (void)setSlotLogProbabilityForCandidateActionPredictions:(id)arg1;
+ (void)setSlotResolutionPredictionItemForTopUpcomingMediaActionContainer:(id)arg1 appActionPredictionItem:(const struct ATXPredictionItem { id x1; unsigned long long x2; float x3[807]; float x4; bool x5; bool x6; }*)arg2 appActionLogProbability:(double)arg3;
...
- (id)actionPredictionsForStatistics:(id)arg1 appActionPredictionItem:(const struct ATXPredictionItem { id x1; unsigned long long x2; float x3[807]; float x4; bool x5; bool x6; }*)arg2 appActionLogProbability:(double)arg3 scoreLogger:(id)arg4 currentDate:(id)arg5;

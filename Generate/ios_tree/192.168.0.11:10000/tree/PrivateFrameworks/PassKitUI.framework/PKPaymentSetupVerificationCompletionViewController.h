...
@interface PKPaymentSetupVerificationCompletionViewController : PKPaymentSetupTableViewController <PKForegroundActiveArbiterObserver, PKPaymentVerificationObserverDelegate, UITextFieldDelegate> {

...
@interface PKPaymentAuthorizationServiceViewController : UIViewController <AKAppleIDAuthenticationInAppContextDelegate, AKSignInViewControllerDelegate, PKAuthenticatorDelegate, PKPaymentAuthorizationFooterViewDelegate, PKPaymentAuthorizationServiceProtocol, PKPaymentAuthorizationStateMachineDelegate, UINavigationControllerDelegate, UITableViewDataSource, UITableViewDelegate> {

...
@interface PKSearchResultsViewController : UICollectionViewController <CNAvatarViewDelegate, PKAccountServiceObserver, PKForegroundActiveArbiterObserver, PKSearchServiceObserver, PKWorldRegionUpdaterObserver, UICollectionViewDelegateFlowLayout, UISearchResultsUpdating> {

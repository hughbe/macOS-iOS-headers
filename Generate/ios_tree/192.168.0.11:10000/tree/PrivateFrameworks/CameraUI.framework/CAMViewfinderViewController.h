...
@interface CAMViewfinderViewController : UIViewController <CAMAvailabilityDelegate, CAMBadgeTrayDelegate, CAMBarsAccessibilityHUDManagerDelegate, CAMBurstDelegate, CAMCameraRollControllerImageWellDelegate, CAMCameraRollControllerPresentationDelegate, CAMCameraRollControllerSessionDelegate, CAMCaptureInterruptionDelegate, CAMCaptureRecoveryDelegate, CAMCaptureRunningDelegate, CAMClosedViewfinderControllerDelegate, CAMConfigurationDelegate, CAMControlDrawerDelegate, CAMControlStatusBarDelegate, CAMControlVisibilityDelegate, CAMControlVisibilityUpdateDelegate, CAMDescriptionOverlayViewDelegate, CAMDisabledPreviewControllerDelegate, CAMDynamicShutterControlAGGDDelegate, CAMDynamicShutterControlDelegate, CAMFacesDelegate, CAMFullscreenModeSelectorDataSource, CAMFullscreenModeSelectorDelegate, CAMFullscreenViewfinderDelegate, CAMHistogramDelegate, CAMMachineReadableCodeDelegate, CAMModeDialDataSource, CAMPanoramaCaptureRequestDelegate, CAMPhysicalCaptureNotifierDelegate, CAMPreviewLayerOverCaptureStatusDelegate, CAMPreviewViewControllerDelegate, CAMRemoteShutterDelegate, CAMShallowDepthOfFieldStatusDelegate, CAMShutterButtonDelegate, CAMStillImageCaptureRequestDelegate, CAMStillImageCapturingVideoDelegate, CAMStorageControllerDelegate, CAMSuggestionDelegate, CAMTimelapseControllerDelegate, CAMTimerButtonDelegate, CAMVideoCaptureRequestDelegate, CAMVideoConfigurationStatusIndicatorDelegate, CAMVideoThumbnailContentsDelegate, CAMZoomControlDelegate, CAMZoomDelegate, CAMZoomSliderDelegate, CEKLightingControlDelegate, CEKWheelScrubberViewDelegate, UIGestureRecognizerDelegate> {
    ...
    <CAMViewfinderViewControllerCaptureRequestTestingDelegate> * _testingDelegate;
...
@property (getter=_isReconfiguringForTripleCameraEmulation, setter=_setReconfiguringForTripleCameraEmulation:, nonatomic) bool _reconfiguringForTripleCameraEmulation;
...
@property (nonatomic) <CAMViewfinderViewControllerCaptureRequestTestingDelegate> *testingDelegate;

...
@interface _TVRXDeviceQuery : NSObject <_TVRCMatchPointDeviceQueryDelegate, _TVRCMediaRemoteDeviceQueryDelegate, _TVRCRMSDeviceQueryDelegate, _TVRCRapportDeviceQueryDelegate> {

...
@interface HDSPTimeAsleepTracker : NSObject <HDSPDevicePowerObserver, HDSPDiagnosticsProvider, HDSPNotificationObserver, HDSPSleepEventHandler, HDSPSleepEventProvider, HDSPSleepModeObserver, HDSPSleepScheduleModelObserver, HDSPSleepScheduleStateObserver, HDSPSleepTracker, HDSPTimeAsleepTrackerStateMachineDelegate, HDSPTimeAsleepTrackerStateMachineInfoProvider, HDSPTimeChangeObserver, HDSPWakeDetector> {
...
@property (nonatomic, readonly) struct os_unfair_lock_s { unsigned int x1; } timeAsleepTrackerLock;
...
- (void)stopDetecting;
- (struct os_unfair_lock_s { unsigned int x1; })timeAsleepTrackerLock;

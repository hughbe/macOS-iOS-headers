...
- (void).cxx_destruct;
- (id)_initWithServiceSpecifier:(id)arg1 fields:(const struct SWCFields { unsigned int x1 : 2; unsigned int x2 : 2; unsigned int x3 : 1; unsigned int x4 : 1; unsigned int x5 : 2; unsigned int x6 : 2; unsigned int x7 : 1; unsigned int x8 : 1; unsigned int x9 : 3; BOOL x10; }*)arg2;
- (id)debugDescription;
- (id)description;

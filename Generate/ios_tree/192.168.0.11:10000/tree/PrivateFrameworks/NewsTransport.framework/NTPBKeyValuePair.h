...
@property (nonatomic, retain) NTPBAudioPlaylistItem *audioPlaylistItem;
@property (nonatomic, retain) NTPBAVAsset *avAsset;
@property (nonatomic, retain) NTPBAVAssetKey *avAssetKey;
...
- (void)setAudioPlaylistItem:(id)arg1;
- (void)setAvAsset:(id)arg1;
- (void)setAvAssetKey:(id)arg1;

...
@property (nonatomic, retain) NTPBAudioEngage *audioEngage;
@property (nonatomic, retain) NTPBAudioEngagementCompleted *audioEngagementCompleted;
...
@property (nonatomic, retain) NTPBPurchaseOffersItem *purchaseOffersItem;
...
- (void)setAudioEngage:(id)arg1;
- (void)setAudioEngagementCompleted:(id)arg1;
...
- (void)setPurchaseOffersItem:(id)arg1;

...
@property (nonatomic, retain) NSString *amsCampaignId;
@property (nonatomic, retain) NSString *amsPurchaseId;
@property (nonatomic) long long appBuild;
@property (nonatomic, retain) NSString *appBuildNumber;
...
@property (nonatomic, retain) NSMutableArray *regionIds;
...
- (void)setAmsCampaignId:(id)arg1;
- (void)setAmsPurchaseId:(id)arg1;
- (void)setAppBuild:(long long)arg1;
- (void)setAppBuildNumber:(id)arg1;

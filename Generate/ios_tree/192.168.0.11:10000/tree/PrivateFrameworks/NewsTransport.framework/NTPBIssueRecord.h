...
@property (nonatomic, retain) COMAPPLEFELDSPARPROTOCOLVersionedPersonalizationVector *personalizationVector;
@property (nonatomic, retain) COMAPPLEFELDSPARPROTOCOLVersionedPersonalizationVector *personalizationVectorAlt;
@property (nonatomic, retain) NSString *personalizationVectorAltFullURL;
@property (nonatomic, retain) NSString *personalizationVectorFullURL;
...
- (id)personalizationVectorAltFullURL;
- (id)personalizationVectorFullURL;
- (id)publishDate;
...
- (void)setPersonalizationVectorAlt:(id)arg1;
- (void)setPersonalizationVectorAltFullURL:(id)arg1;
- (void)setPersonalizationVectorFullURL:(id)arg1;

...
@interface BBServer : NSObject <AFSiriUserNotificationRequestCapabilityObserving, BBDataProviderManagerDelegate, BBSectionAuthorizationManagerDelegate, BBServerConduitServerInterface, BBSettingsGatewayServerInterface, BBSyncServiceDelegate, NSXPCListenerDelegate> {

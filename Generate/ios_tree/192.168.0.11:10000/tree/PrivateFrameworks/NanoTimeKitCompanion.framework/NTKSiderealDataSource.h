...
+ (id)_allAvailableSolarEventsForLocation:(struct { double x1; double x2; })arg1 atDate:(id)arg2;
...
+ (id)_solarEventsForLocation:(struct { double x1; double x2; })arg1 withInfo:(id)arg2 atDate:(id)arg3;

...
@property (nonatomic, readonly) CAShapeLayer *bubbleGlyphLayer;
...
@property (nonatomic, readonly) CAShapeLayer *totalRingLayer;
@property (nonatomic, readonly) CAShapeLayer *waitingContainerLayer;

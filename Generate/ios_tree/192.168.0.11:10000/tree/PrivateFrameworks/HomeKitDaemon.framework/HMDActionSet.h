...
- (void)_executeGenericActions:(id)arg1 source:(unsigned long long)arg2 completionHandler:(id /* block */)arg3;
- (void)_executeMediaPlaybackActions:(id)arg1 source:(unsigned long long)arg2 completionHandler:(id /* block */)arg3;
- (bool)_fixupActions;

...
@interface HMDHomeKitPersonDataReceiver : HMFObject <HMDActiveXPCClientConnectionsPeriodicTimerDelegate, HMDPersonDataReceiver, HMFLogging, HMFMessageReceiver> {
    NSUUID * _UUID;

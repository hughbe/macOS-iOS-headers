...
@interface Project : NSObject <NSKeyedUnarchiverDelegate, PVImageDelegate, PVStabilizationDelegate> {
    bool  _allowsSplits;
...
@property (nonatomic) struct CGSize { double x1; double x2; } explicitOutputSize;
...
- (bool)compareTimingMethodsForStabilizationConfigLookup:(id)arg1 forTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg2 frameData:(struct __CVBuffer { }*)arg3 irisMovieClip:(id)arg4;
...
- (bool)didStabilize:(id)arg1 time:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg2 frameData:(struct __CVBuffer { }*)arg3 inputSize:(struct CGSize { double x1; double x2; })arg4 cleanAperture:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg5 centeredCleanAperture:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg6 cleanApertureOriginZero:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg7 cropRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg8 homography:(struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[3]; })arg9 homographyMatrix4x4:(struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[4]; })arg10 userContext:(id)arg11;
- (id)displayName;
...
- (id)expandedEditList;
- (struct CGSize { double x1; double x2; })explicitOutputSize;
- (bool)exportAt60fps;
- (id)exportDirectory;
...
- (void)setExplicitOutputSize:(struct CGSize { double x1; double x2; })arg1;
...
- (void)setStabilizationDict:(id)arg1;
...
- (id)timedStabilizationConfigForTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg1 frameData:(struct __CVBuffer { }*)arg2 userContext:(id)arg3;
- (id)timedStabilizationConfigInArray:(id)arg1 useNewMethod:(bool)arg2 forTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg3 frameData:(struct __CVBuffer { }*)arg4 irisMovieClip:(id)arg5 frameIndex:(out long long*)arg6;
- (id)trailerDict;

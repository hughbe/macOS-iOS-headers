...
- (id)initWithPropertySupplier:(id /* block */)arg1 screenType:(unsigned long long)arg2 additionalInsets:(struct NSEdgeInsets { double x1; double x2; double x3; double x4; })arg3 displayDictionary:(id)arg4;

...
- (void).cxx_destruct;
- (id)_initWithItem:(id)arg1 parentItem:(id)arg2 replyMessageGUID:(id)arg3 replyIsFromMe:(bool)arg4 initialPayload:(id)arg5 index:(long long)arg6 messagePartRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg7 parentChatHasKnownParticipants:(bool)arg8;
- (id)_parentItem;
- (bool)canDelete;

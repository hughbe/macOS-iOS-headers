...
- (void).cxx_destruct;
- (void)_dispatchEventWithName:(id)arg1 payload:(id)arg2 values:(id)arg3 inputMode:(id)arg4 testingParameters:(id)arg5 allowSparsePayload:(bool)arg6 withCompletionHandler:(id /* block */)arg7;

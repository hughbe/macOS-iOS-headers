...
@interface WLMigrationDataCoordinator : NSObject {
    <WLMigrationDataCoordinatorDelegate> * _delegate;
    bool  _doneSent;
    bool  _stashDataLocally;
}

@property (nonatomic, readonly) <WLMigrationDataCoordinatorDelegate> *delegate;
...
- (void)updateSource:(id)arg1 withProgress:(double)arg2 completion:(id /* block */)arg3;

...
+ (void)configurationFromURL:(id)arg1 forSession:(id)arg2 usingAuth:(id)arg3 authProvider:(id)arg4 parentNetworkActivity:(id)arg5 keyID:(id)arg6 publicKey:(id)arg7 URLSessionConfiguration:(id)arg8 completion:(id /* block */)arg9;

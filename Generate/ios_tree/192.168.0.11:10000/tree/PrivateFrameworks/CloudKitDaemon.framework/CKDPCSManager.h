...
- (void)_createPCSFromData:(id)arg1 ofType:(unsigned long long)arg2 usingPCSServiceType:(unsigned long long)arg3 withSyncKeyRegistryRetry:(bool)arg4 zonePCSModificationDate:(id)arg5 completionHandler:(id /* block */)arg6;
...
- (void)_locked_createPCSFromData:(id)arg1 ofType:(unsigned long long)arg2 usingPCSServiceType:(unsigned long long)arg3 withSyncKeyRegistryRetry:(bool)arg4 zonePCSModificationDate:(id)arg5 keySyncAnalytics:(id)arg6 completionHandler:(id /* block */)arg7;
- (void)_locked_createZonePCSWithSyncKeyRegistryRetry:(bool)arg1 keySyncAnalytics:(id)arg2 completionHandler:(id /* block */)arg3;
...
- (void)_locked_preflightIdentitiesForService:(unsigned long long)arg1 withSyncKeyRegistryRetry:(bool)arg2 keySyncAnalytics:(id)arg3 completionHandler:(id /* block */)arg4;
...
- (void)createZonePCSFromData:(id)arg1 usingServiceIdentityWithType:(unsigned long long)arg2 zonePCSModificationDate:(id)arg3 completionHandler:(id /* block */)arg4;
...
- (id)synchronizeQueue;
- (void)synchronizeUserKeyRegistryForServiceType:(unsigned long long)arg1 shouldThrottle:(bool)arg2 context:(id)arg3 completionHandler:(id /* block */)arg4;

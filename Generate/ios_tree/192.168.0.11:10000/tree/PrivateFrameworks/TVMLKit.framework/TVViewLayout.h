...
@property (nonatomic) struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; } focusTransform;
...
- (struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })focusTransform;
- (id)group;
- (double)height;
- (id)highlightColor;
- (id)highlightStyle;
...
- (void)setFocusTransform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg1;

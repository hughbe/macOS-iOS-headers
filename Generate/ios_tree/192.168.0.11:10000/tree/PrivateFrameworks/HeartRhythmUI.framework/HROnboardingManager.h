...
@interface HROnboardingManager : NSObject <HROnboardingPageViewControllerDelegate, UINavigationControllerDelegate> {
    ...
    <HROnboardingManagerDataSource> * _dataSource;
    HKDateCache * _dateCache;
    <HROnboardingManagerDelegate> * _delegate;
...
@property (nonatomic, retain) HROnboardingSequence *currentSequence;
@property (nonatomic) long long currentStepIndex;
@property (nonatomic) <HROnboardingManagerDataSource> *dataSource;
@property (nonatomic, retain) HKDateCache *dateCache;
@property (readonly, copy) NSString *debugDescription;
@property (nonatomic) <HROnboardingManagerDelegate> *delegate;

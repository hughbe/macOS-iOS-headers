...
@property /* Warning: unhandled struct encoding: '{Options={basic_string<char' */ struct  fTestOptions; /* unknown property attribute:  std::__1::allocator<char> >={__rep=(?={__long=*QQ}{__short=[23c]{?=C}}{__raw=[3Q]})}}}IIQBBBBBBBBBBiiiiC(Subband=ii)iiiiiiiBi} */

...
- (void)_reallyBeginExtensionRequestWithInputItems:(id)arg1 pkUUID:(id)arg2 processAssertion:(id)arg3 listenerEndpoint:(id)arg4 completion:(id /* block */)arg5;
...
- (void)_safelyBeginUsingSynchronously:(bool)arg1 options:(unsigned long long)arg2 pkUUID:(id)arg3 withAssertion_onSafeQueue:(id /* block */)arg4;
- (void)_safelyBeginUsingWithOptions:(unsigned long long)arg1 pkUUID:(id)arg2 withAssertion_onSafeQueue:(id /* block */)arg3;

...
@interface PXAlbumStreamingOptionsViewController : UIViewController <PLInvitationRecordsObserver, UITableViewDataSource, UITableViewDelegate> {
    ...
    <PXAlbumStreamingOptionsViewControllerDelegate> * _delegate;
...
@property (setter=_setShowingPublicURLActivitySpinner:, nonatomic) bool _showingPublicURLActivitySpinner;
@property (nonatomic, retain) PLCloudSharedAlbum *album;
@property (nonatomic) bool albumIsFamilyStream;
@property (nonatomic, copy) NSString *albumName;
@property (readonly, copy) NSString *debugDescription;
@property (nonatomic) <PXAlbumStreamingOptionsViewControllerDelegate> *delegate;

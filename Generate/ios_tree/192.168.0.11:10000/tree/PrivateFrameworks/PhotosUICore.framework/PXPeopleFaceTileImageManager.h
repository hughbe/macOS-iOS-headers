...
- (id)_cachedResultForIdentifier:(id)arg1 params:(struct PXFaceTileImageParams { struct CGSize { double x_1_1_1; double x_1_1_2; } x1; unsigned long long x2; unsigned long long x3; bool x4; })arg2 isLowResResult:(bool*)arg3;
- (void)_cropImage:(id)arg1 synchronous:(bool)arg2 cacheResult:(bool)arg3 isDegraded:(bool)arg4 forRequest:(id)arg5 cropInfo:(struct { bool x1; struct CGPoint { double x_2_1_1; double x_2_1_2; } x2; })arg6 didCallFastBlock:(bool)arg7 completionBlock:(id /* block */)arg8;
...
- (void)_requestFaceTileImageRequest:(id)arg1 faceImageRequest:(id)arg2 cacheResult:(bool)arg3 completionBlock:(id /* block */)arg4 fastDisplayBlock:(id /* block */)arg5;
...
- (int)requestFaceTileImageFromRequest:(id)arg1 withTargetSize:(struct CGSize { double x1; double x2; })arg2 cropFactor:(unsigned long long)arg3 style:(unsigned long long)arg4 completionBlock:(id /* block */)arg5 fastDisplayBlock:(id /* block */)arg6;

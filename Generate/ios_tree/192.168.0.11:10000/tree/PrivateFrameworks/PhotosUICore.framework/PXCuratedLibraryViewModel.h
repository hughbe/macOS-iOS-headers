...
@interface PXCuratedLibraryViewModel : PXObservable <PXAssetsDataSourceManagerObserver, PXChangeObserver, PXCuratedLibraryAssetsDataSourceManagerDelegate, PXMutablePhotosLibraryViewModel, PXSettingsKeyObserver, PXUIKeyCommandNamespace> {
...
@property (nonatomic, readonly) NSObject<PXFilterState> *allPhotosFilterState;
...
@property (nonatomic, readonly) NSObject<PXFilterState> *currentFilterState;

...
+ (void)_requestMonogramForFirstName:(id)arg1 lastName:(id)arg2 targetSize:(struct CGSize { double x1; double x2; })arg3 completion:(id /* block */)arg4;
...
+ (void)requestImageForContact:(id)arg1 targetSize:(struct CGSize { double x1; double x2; })arg2 completion:(id /* block */)arg3;

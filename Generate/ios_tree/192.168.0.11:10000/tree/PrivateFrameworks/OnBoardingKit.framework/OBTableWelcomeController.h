...
@property (nonatomic) struct UIEdgeInsets { double x1; double x2; double x3; double x4; } hostedTableFooterPadding;
...
- (struct UIEdgeInsets { double x1; double x2; double x3; double x4; })hostedTableFooterPadding;
...
- (void)setHostedTableFooterPadding:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg1;

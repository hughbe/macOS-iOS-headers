...
@interface RTStoredLocationEnumerationContext : NSObject <NSCopying, NSSecureCoding> {
    unsigned long long  _offset;
    RTStoredLocationEnumerationOptions * _options;
}

@property (nonatomic, readonly) unsigned long long offset;
@property (nonatomic, readonly, copy) RTStoredLocationEnumerationOptions *options;

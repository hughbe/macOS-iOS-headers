...
- (void)_routeConfigUpdatedWithID:(struct __CFString { }*)arg1 reason:(struct __CFString { }*)arg2 initiator:(const struct __CFString { }*)arg3 endedError:(const struct __CFString { }*)arg4 deviceID:(const struct __CFString { }*)arg5 previousDeviceIDs:(const struct __CFArray { }*)arg6;

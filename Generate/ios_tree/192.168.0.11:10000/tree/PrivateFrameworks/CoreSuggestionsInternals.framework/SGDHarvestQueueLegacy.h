...
- (void).cxx_destruct;
- (void)addItemWithSourceKey:(id)arg1 messageId:(id)arg2 highPriority:(bool)arg3 item:(id)arg4 customPriorityCriteria:(unsigned char)arg5 callback:(id /* block */)arg6;
- (void)close;

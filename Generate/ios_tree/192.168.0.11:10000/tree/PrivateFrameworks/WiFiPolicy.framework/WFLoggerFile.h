...
@property (getter=getLogDirPath, readonly) const struct __CFString { }*logDirPath;
@property (getter=getLogFileNamePrefix, readonly) const struct __CFString { }*logFileNamePrefix;
@property (getter=getLogFilePath, readonly) const struct __CFString { }*logFilePath;
...
- (const struct __CFString { }*)getLogDirPath;
- (const struct __CFString { }*)getLogFileNamePrefix;
- (const struct __CFString { }*)getLogFilePath;

...
+ (void)addStopsFromArray:(const struct OABGradientStop { id x1; float x2; }*)arg1 stopCount:(int)arg2 inverted:(bool)arg3 startPos:(float)arg4 endPos:(float)arg5 toStopArray:(id)arg6 fillPropertiesManager:(id)arg7;

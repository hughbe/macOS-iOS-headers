...
@interface UIColor : NSObject <DebugHierarchyValue_Fallback, LPCSSText, LPHTMLAttributeText, NSCopying, NSItemProviderReading, NSItemProviderWriting, NSSecureCoding, TSDPathPainter, UIColorJSExports, UIItemProviderReading, UIItemProviderWriting> {

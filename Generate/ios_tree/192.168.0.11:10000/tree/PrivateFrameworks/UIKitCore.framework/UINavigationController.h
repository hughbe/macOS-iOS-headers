...
@interface UINavigationController : UIViewController <DebugHierarchyObject_Fallback, GKContentRefresh, GKURLHandling, UIGestureRecognizerDelegatePrivate, UIInterfaceOrientationMaskOverride, UILayoutContainerViewDelegate, _UINavigationBarDelegatePrivate, _UIScrollViewScrollObserver, _UIToolbarDelegateInternal> {

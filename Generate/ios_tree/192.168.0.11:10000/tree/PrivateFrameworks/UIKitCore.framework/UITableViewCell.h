...
@interface UITableViewCell : UIView <DebugHierarchyObject_Fallback, NSCoding, UIGestureRecognizerDelegate, UIScrollViewDelegate, UITableConstantsCellProviding, _UIInteractiveHighlighting, _UILayoutEngineSuspending, _UISystemBackgroundViewContainer> {

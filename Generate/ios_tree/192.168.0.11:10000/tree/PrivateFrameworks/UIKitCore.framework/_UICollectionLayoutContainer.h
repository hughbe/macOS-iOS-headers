...
- (id)initWithContentSize:(struct CGSize { double x1; double x2; })arg1 contentInsets:(struct NSDirectionalEdgeInsets { double x1; double x2; double x3; double x4; })arg2 insetsEnvironment:(id)arg3;
- (id)insetsEnvironment;

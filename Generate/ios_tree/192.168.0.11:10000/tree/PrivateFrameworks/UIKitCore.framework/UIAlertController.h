...
@interface UIAlertController : UIViewController <DebugHierarchyObject_Fallback, UIAlertControllerContaining, UIAlertControllerVisualStyleProviding, UIPreviewInteractionControllerDelegate, WFAlertPresenter, _UIAlertControllerTextFieldViewControllerContaining> {

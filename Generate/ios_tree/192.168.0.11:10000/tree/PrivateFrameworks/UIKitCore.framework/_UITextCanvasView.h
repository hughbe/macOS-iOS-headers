...
@interface _UITextCanvasView : UIView <_UIDrawsTextInRect, _UITextTiledLayerDelegate> {
    <_UITextCanvasViewContext> * _context;
...
@property (nonatomic) <_UITextCanvasViewContext> *context;

...
@interface UIResponder : NSObject <DebugHierarchyObject_Fallback, UIResponderStandardEditActions, UITextInputAdditions, UITextInput_Internal, UIUserActivityRestoring, _UIPressesEventRespondable, _UIStateRestorationContinuation, _UITouchesEventRespondable> {
    struct { 

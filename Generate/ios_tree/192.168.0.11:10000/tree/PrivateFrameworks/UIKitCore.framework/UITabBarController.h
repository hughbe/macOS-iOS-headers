...
@interface UITabBarController : UIViewController <DebugHierarchyObject_Fallback, GKContentRefresh, GKURLHandling, NSCoding, PXProgrammaticNavigationUpdateTarget, UIGestureRecognizerDelegate, UILayoutContainerViewDelegate, UITabBarDelegate, _UIScrollViewScrollObserver, _UITVScrollViewManagerDelegate, _UITabBarDelegateInternal> {

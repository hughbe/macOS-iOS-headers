...
@interface UISearchBar : UIView <DebugHierarchyObject_Fallback, UIBarPositioning, UIScribbleInteractionDelegate, UITextInputTraits, UITextInputTraits_Private, _UIBarPositioningInternal, _UINavigationBarAugmentedTitleView, _UISearchBarVisualProvidingDelegate> {

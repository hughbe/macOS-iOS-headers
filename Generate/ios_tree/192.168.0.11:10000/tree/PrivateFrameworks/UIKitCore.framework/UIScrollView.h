...
@interface UIScrollView : UIView <DebugHierarchyObject_Fallback, NSCoding, UIFocusItemScrollableContainer, UIGestureRecognizerDelegateInternal, UIIndexBarAccessoryViewDelegate, UIPanGestureRecognizerDelegateInternal, UIScrollViewDelayedTouchesBeganGestureRecognizerClient, _UIScrollToTopView> {

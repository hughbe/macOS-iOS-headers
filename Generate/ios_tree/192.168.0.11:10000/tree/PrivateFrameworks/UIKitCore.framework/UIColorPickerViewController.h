...
@interface UIColorPickerViewController : UIViewController <_UIColorPickerColorQueueDelegate, _UIColorPickerRemoteViewControllerHost, _UIGeometryChangeObserver, _UIRemoteViewControllerContaining> {

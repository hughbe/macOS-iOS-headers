...
@interface UIDropInteraction : NSObject <UIDragGestureRecognizerDelegate, UIDragInteraction, UIInteraction, UIInteraction_Internal, _UIDragSetDownAnimationTarget> {

...
@interface UISearchController : UIViewController <DebugHierarchyObject_Fallback, NSCoding, TSPresentable, UIGestureRecognizerDelegate, UIViewControllerAnimatedTransitioning, UIViewControllerTransitioningDelegate, _UIScrollViewScrollObserver_Internal> {

...
@interface UICollectionView : UIScrollView <DebugHierarchyObject_Fallback, UIContextMenuInteractionDelegate, UIDataSourceTranslating, _UIDataSourceBackedView, _UIHorizontalIndexTitleBarDelegate, _UIKeyboardAutoRespondingScrollView> {

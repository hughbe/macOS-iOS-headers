...
@interface UIButton : UIControl <ABText, CAMAccessibilityHUDItemProvider, DebugHierarchyObject_Fallback, NSCoding, TSDPlatformButtonProtocol, UIAccessibilityContentSizeCategoryImageAdjusting, UIAccessibilityContentSizeCategoryImageAdjustingInternal, UIButtonControl, UIGestureRecognizerDelegate, _UIFloatingContentViewDelegate> {

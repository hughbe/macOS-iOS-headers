...
@property (nonatomic, copy) id /* block */ itemsProvider;
@property (nonatomic) long long layoutDirection;
@property (nonatomic, copy) NSArray *subitems;
@property (nonatomic, copy) NSArray *supplementaryItems;
@property (nonatomic, copy) id /* block */ visualFormatItemProvider;
...
- (void)setItemsProvider:(id /* block */)arg1;
- (void)setLayoutDirection:(long long)arg1;
- (void)setSubitems:(id)arg1;
- (void)setVisualFormatItemProvider:(id /* block */)arg1;

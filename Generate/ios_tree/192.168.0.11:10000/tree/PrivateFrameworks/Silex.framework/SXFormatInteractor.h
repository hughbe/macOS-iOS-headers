...
@interface SXFormatInteractor : NSObject <SXDebugLayoutOptionsObserving, SXFormatInteractor, SXLayoutCoordinatorDelegate, SXNewsletterSubscriptionStatusObserving, SXPresentationAttributesObserver, SXSubscriptionStatusObserving> {

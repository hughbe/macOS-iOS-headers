...
@interface SXVideoComponentView : SXMediaComponentView <SWReachabilityObserver, SXFullscreenVideoPlaybackCandidate, SXMediaPlaybackDelegate, SXVideoPlayerViewControllerDataSource, SXVideoPlayerViewControllerDelegate, SXViewportChangeListener> {

...
@interface SBSUIWallpaperPreviewViewController : UIViewController <SBFLegibilitySettingsProvider, SBFLegibilitySettingsProviderDelegate, SBSUIWallpaperPreviewViewDelegate> {

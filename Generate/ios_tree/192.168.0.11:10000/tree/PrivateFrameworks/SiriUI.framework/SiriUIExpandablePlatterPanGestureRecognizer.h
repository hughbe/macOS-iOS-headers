...
@interface SiriUIExpandablePlatterPanGestureRecognizer : UIPanGestureRecognizer <UIGestureRecognizerDelegate> {
    ...
    <SiriUIExpandablePlatterPanGestureRecognizerDelegate> * _expansionDelegate;
...
@property (nonatomic) <SiriUIExpandablePlatterPanGestureRecognizerDelegate> *expansionDelegate;

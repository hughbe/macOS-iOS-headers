...
@property (nonatomic, readonly) NSArray *widgetsAddedToStacks;
@property (nonatomic, readonly) NSArray *widgetsDeletedFromStacks;
...
- (id)widgetsAddedToStacks;
- (id)widgetsDeletedFromStacks;

...
+ (bool)_enumerateSampleTypeWithProfile:(id)arg1 quantityType:(id)arg2 predicate:(id)arg3 error:(id*)arg4 block:(id /* block */)arg5;
+ (bool)_enumerateWithProfile:(id)arg1 quantityType:(id)arg2 predicate:(id)arg3 filter:(id)arg4 isQuantityType:(bool)arg5 includeUnfrozenSeries:(bool)arg6 error:(id*)arg7 block:(id /* block */)arg8;

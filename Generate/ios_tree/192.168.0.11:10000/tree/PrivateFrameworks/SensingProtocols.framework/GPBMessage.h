...
@interface GPBMessage : NSObject <NSCopying, NSSecureCoding> {
    NSMutableDictionary * autocreatedExtensionMap_;
    GPBExtensionDescriptor * autocreatorExtension_;
    GPBFieldDescriptor * autocreatorField_;
    GPBMessage * autocreator_;
    NSMutableDictionary * extensionMap_;
    struct GPBMessage_Storage { unsigned int x1[0]; } * messageStorage_;
...
- (void)writeExtensionsToCodedOutputStream:(id)arg1 range:(struct GPBExtensionRange { unsigned int x1; unsigned int x2; })arg2 sortedExtensions:(id)arg3;

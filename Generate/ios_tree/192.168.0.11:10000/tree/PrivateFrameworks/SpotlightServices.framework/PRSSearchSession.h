...
@property (nonatomic, readonly) NSString *experimentNamespaceId;
@property (readonly) unsigned long long hash;
@property (nonatomic, readonly) bool isClientOnlyExperiment;
@property (nonatomic, readonly) bool isInReservedAllocationForExperiment;

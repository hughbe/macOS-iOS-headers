...
@property (nonatomic) struct _VUICornerRadii { double x1; double x2; double x3; double x4; } cornerRadii;
...
- (struct _VUICornerRadii { double x1; double x2; double x3; double x4; })cornerRadii;
- (bool)cropToFit;
...
- (void)setCornerRadii:(struct _VUICornerRadii { double x1; double x2; double x3; double x4; })arg1;

...
@property (nonatomic) struct { unsigned int x1; unsigned int x2; double x3; double x4; } currentChannelMetrics;
...
- (id)currentAudioTier;
- (struct { unsigned int x1; unsigned int x2; double x3; double x4; })currentChannelMetrics;
- (void)dealloc;
- (id)delegate;
- (id)dtxMetrics;
...
- (void)setCurrentChannelMetrics:(struct { unsigned int x1; unsigned int x2; double x3; double x4; })arg1;

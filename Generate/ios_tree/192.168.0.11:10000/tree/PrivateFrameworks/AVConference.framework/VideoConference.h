...
@interface VideoConference : VCObject <GKNATObserverDelegate, VCAudioIODelegate, VCAudioIOSink, VCAudioIOSource, VCAudioPowerLevelMonitorDelegate, VCCallSessionDelegate, VCMomentTransportDelegate, VCVideoCaptureClient, VCVideoSink> {
    VCAudioIO * _audioIO;
...
@property (nonatomic, readonly) VCMoments *vcMoments;

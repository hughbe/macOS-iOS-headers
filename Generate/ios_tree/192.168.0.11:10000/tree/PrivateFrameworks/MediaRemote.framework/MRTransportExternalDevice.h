...
@property (nonatomic, retain) MROrigin *customOrigin;
...
@property (nonatomic, retain) MRContentItem *nowPlayingItem;
...
- (void)_sendClientMessage:(id)arg1 completion:(id /* block */)arg2;

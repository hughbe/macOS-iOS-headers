...
@interface BNBannerSource : NSObject <BNBannerClientContainerDelegate, BNBannerSceneComponentProviderDelegate, BNBannerSourceHostToClientInterface, BNBannerSourceProviding, BNBannerSourceProvidingPrivate> {

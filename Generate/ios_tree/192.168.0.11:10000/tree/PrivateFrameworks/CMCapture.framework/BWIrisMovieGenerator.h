...
+ (bool)_addNewMetadataTrackToAssetWriter:(struct OpaqueFigAssetWriter { }*)arg1 forTrackTimeScale:(int)arg2 yieldingTrackID:(int*)arg3;
+ (void)initialize;
...
- (id)initWithReadableByteStream:(struct OpaqueCMByteStream { }*)arg1 metadataByteStream:(struct OpaqueCMByteStream { }*)arg2 forFrontFacingCamera:(bool)arg3 sampleReferenceMoviesEnabled:(bool)arg4 movieGenerationQueue:(id)arg5 irisStillImageMovieMetadataCache:(id)arg6 videoOrientationTimeMachine:(id)arg7;

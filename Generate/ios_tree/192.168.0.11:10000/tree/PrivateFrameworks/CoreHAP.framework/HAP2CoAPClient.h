...
- (id)initWithSocketAddress:(const struct sockaddr { unsigned char x1; unsigned char x2; BOOL x3[14]; }*)arg1 maxTransmitAttempts:(unsigned long long)arg2 initialACKTimeout:(double)arg3;

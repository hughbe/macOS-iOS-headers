...
- (void)setMiniPlaceBrowseCategories:(id)arg1;
- (void)setPhoto:(id)arg1;
- (void)setPlaceBrowseCategories:(id)arg1;
- (void)setPlaceCollection:(id)arg1;
- (void)setPlaceCollectionItem:(id)arg1;
...
- (void)setVendorAmenities:(id)arg1;

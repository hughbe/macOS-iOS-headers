...
+ (id)_segmentForSteps:(id)arg1 withRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2 andCustodian:(id)arg3 andDecoderData:(id)arg4 andSuggestedRoute:(id)arg5 andRideSelections:(id)arg6 andSectionOptions:(id)arg7 andUpdateTripCount:(unsigned long long*)arg8;

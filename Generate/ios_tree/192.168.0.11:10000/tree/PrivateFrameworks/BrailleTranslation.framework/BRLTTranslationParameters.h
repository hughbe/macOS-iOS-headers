...
- (id)initWithLanguage:(id)arg1 mode:(unsigned long long)arg2 partial:(bool)arg3 useTechnicalTable:(bool)arg4 textPositionsRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg5;
- (bool)isPartial;
- (id)language;

...
@interface VCConfiguredSleepWorkflow : NSObject <NSCopying, NSSecureCoding, WFGlyphDrawableItem, WFWorkflowReferenceConvertible> {
...
+ (void)getObjectsFromReferences:(id)arg1 completion:(id /* block */)arg2;

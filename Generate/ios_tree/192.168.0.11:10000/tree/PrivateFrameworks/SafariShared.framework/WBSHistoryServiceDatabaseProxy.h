...
- (void)assignHistoryItemWithID:(long long)arg1 toTopicTagsWithIDs:(id)arg2 completionHandler:(id /* block */)arg3;
...
- (void)recordVisitWithIdentifier:(id)arg1 sourceVisit:(id)arg2 title:(id)arg3 wasHTTPNonGet:(bool)arg4 loadSuccessful:(bool)arg5 origin:(long long)arg6 attributes:(unsigned long long)arg7 completionHandler:(id /* block */)arg8;
...
- (void)updateWithType:(unsigned long long)arg1 addOrModifyObjects:(id)arg2 updateCurrentGeneration:(id)arg3 updateLastSyncGeneration:(id)arg4 updateLastMaintenance:(id)arg5 completionHandler:(id /* block */)arg6;

...
- (id)_frameView;
- (bool)_handleEditingKeyEvent:(struct KeyboardEvent { int (**x1)(); struct Weak<WebCore::JSDOMObject> { struct WeakImpl {} *x_2_1_1; } x2; unsigned int x3; unsigned int x4 : 1; unsigned int x5 : 1; unsigned int x6 : 1; unsigned int x7 : 1; unsigned int x8 : 1; unsigned int x9 : 1; unsigned int x10 : 1; unsigned int x11 : 1; unsigned int x12 : 1; unsigned int x13 : 1; unsigned int x14 : 1; unsigned int x15 : 2; struct AtomString { struct String { struct RefPtr<WTF::StringImpl, WTF::DumbPtrTraits<WTF::StringImpl> > { struct StringImpl {} *x_1_3_1; } x_1_2_1; } x_16_1_1; } x16; struct RefPtr<WebCore::EventTarget, WTF::DumbPtrTraits<WebCore::EventTarget> > { struct EventTarget {} *x_17_1_1; } x17; struct EventPath {} *x18; struct RefPtr<WebCore::EventTarget, WTF::DumbPtrTraits<WebCore::EventTarget> > { struct EventTarget {} *x_19_1_1; } x19; struct MonotonicTime { double x_20_1_1; } x20; struct RefPtr<WebCore::Event, WTF::DumbPtrTraits<WebCore::Event> > { struct Event {} *x_21_1_1; } x21; struct RefPtr<WebCore::WindowProxy, WTF::DumbPtrTraits<WebCore::WindowProxy> > { struct WindowProxy {} *x_22_1_1; } x22; }*)arg1;

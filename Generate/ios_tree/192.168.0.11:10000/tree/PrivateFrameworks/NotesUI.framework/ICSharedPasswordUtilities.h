...
- (void).cxx_destruct;
- (void)_authenticateForNote:(id)arg1 intent:(unsigned long long)arg2 displayWindow:(id)arg3 failedAttemptHandler:(id /* block */)arg4 completionHandler:(id /* block */)arg5;
- (void)_recursivelyAuthenticateForNotes:(id)arg1 intent:(unsigned long long)arg2 displayWindow:(id)arg3 completionHandler:(id /* block */)arg4;
- (void)authenticateForDeletingNotes:(id)arg1 displayWindow:(id)arg2 completionHandler:(id /* block */)arg3;
- (void)authenticateForNote:(id)arg1 intent:(unsigned long long)arg2 displayWindow:(id)arg3 failedAttemptHandler:(id /* block */)arg4 completionHandler:(id /* block */)arg5;
- (void)authenticateForNotes:(id)arg1 intent:(unsigned long long)arg2 displayWindow:(id)arg3 completionHandler:(id /* block */)arg4;

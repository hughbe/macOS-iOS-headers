...
@property (nonatomic, retain) NFLazy *ckProperties;
...
@property (nonatomic, retain) NSOperationQueue *highPriorityOperationQueue;
...
- (void)setHighPriorityOperationQueue:(id)arg1;
...
- (void)setSentinelRecord:(id)arg1;

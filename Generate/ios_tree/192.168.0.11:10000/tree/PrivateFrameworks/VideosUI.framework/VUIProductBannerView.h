...
@property (nonatomic, retain) _TVImageView *logoTextGradientView;
@property (nonatomic, retain) VUILabel *logoTextView;
@property (nonatomic) bool prefersUberLayout;
@property (nonatomic, retain) VUILabel *promoTextView;
...
- (void)setLogoTextGradientView:(id)arg1;
- (void)setLogoTextView:(id)arg1;
- (void)setPrefersUberLayout:(bool)arg1;
- (void)setPromoTextView:(id)arg1;

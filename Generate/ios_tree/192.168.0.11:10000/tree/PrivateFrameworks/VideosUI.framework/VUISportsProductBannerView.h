...
@property (nonatomic, retain) UIView *availabilityImageView;
...
- (void).cxx_destruct;
- (struct CGSize { double x1; double x2; })_availabilityImageSizeWithSize:(struct CGSize { double x1; double x2; })arg1;
- (double)_availabilityImageViewLeftMargin;

...
@interface MPCModelPlaybackContext : MPPlaybackContext <MPCModelPlaybackRequestEnvironmentConsuming, MPCPlaybackContextPrivateListeningOverridable, MPCPlaybackContextUserIdentityConsuming> {

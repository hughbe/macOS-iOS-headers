...
- (id)createPVRenderRequestUsingAnimojiRenderer:(id)arg1 metadataValidator:(id)arg2 additionalTransform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg3 effectStack:(id)arg4 animojiTapPoint:(bool)arg5 requestHandler:(id*)arg6;

...
- (struct __CVBuffer { }*)newPixelBufferRenderedFromARFrame:(id)arg1 withEffect:(id)arg2 depthData:(id)arg3 captureOrientation:(long long)arg4 interfaceOrientation:(long long)arg5 preRecordedBlendShapes:(id)arg6;
- (id)preRecordedBlendShapesForFrame:(id)arg1 captureOrientation:(long long)arg2 interfaceOrientation:(long long)arg3;
- (void)renderAnimoji:(id)arg1 withPresentationTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg2 depthData:(id)arg3 completionBlock:(id /* block */)arg4;
- (void)renderFrame:(id)arg1 withEffect:(id)arg2 depthData:(id)arg3 captureOrientation:(long long)arg4 interfaceOrientation:(long long)arg5 preRecordedBlendShapes:(id)arg6 completionBlock:(id /* block */)arg7;
- (id)renderPassLock;

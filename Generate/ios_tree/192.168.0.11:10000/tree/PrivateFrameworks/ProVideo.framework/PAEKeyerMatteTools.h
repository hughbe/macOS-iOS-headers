...
- (bool)doMatteManipulationWithInfo:(struct { union { double x_1_1_1; struct { /* ? */ } *x_1_1_2; } x1; unsigned long long x2; unsigned long long x3; double x4; double x5; unsigned long long x6; })arg1 pixelAspectRatio:(float)arg2 fieldHeight:(float)arg3 doInvertMatte:(bool)arg4 inputIsInverted:(bool)arg5 fillHoles:(bool)arg6 scaling:(bool)arg7 blendingGamma:(float)arg8 blackLevel:(double)arg9 whiteLevel:(double)arg10 gammaLevel:(double)arg11 preKeyedInputNode:(struct HGRef<HGNode> { struct HGNode {} *x1; }*)arg12 outputNode:(struct HGRef<HGNode> { struct HGNode {} *x1; }*)arg13;

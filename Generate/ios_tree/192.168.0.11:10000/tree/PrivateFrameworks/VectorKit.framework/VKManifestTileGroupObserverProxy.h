...
@property /* Warning: unhandled struct encoding: '{function<void (GEOResourceManifestManager *' */ struct  didChangeActiveTileGroup; /* unknown property attribute:  GEOActiveTileGroup *)>}}} */

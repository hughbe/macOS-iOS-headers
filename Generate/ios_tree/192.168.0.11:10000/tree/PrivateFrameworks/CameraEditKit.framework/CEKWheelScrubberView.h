...
@interface CEKWheelScrubberView : UIView <CEKWheelScrubberCollectionViewLayoutDelegate, UICollectionViewDataSource, UICollectionViewDelegate, UIGestureRecognizerDelegate, UIPreviewInteractionDelegate> {

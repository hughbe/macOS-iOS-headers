...
- (id)initWithTouchPoint:(struct CGPoint { double x1; double x2; })arg1 radius:(double)arg2 timestamp:(double)arg3 inflectionPoint:(bool)arg4 touchHistory:(const struct RefPtr<TI::Favonius::CMTouchHistory> { struct CMTouchHistory {} *x1; }*)arg5;

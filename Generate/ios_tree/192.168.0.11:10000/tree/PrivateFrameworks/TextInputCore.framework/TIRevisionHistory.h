...
- (void)acceptToken:(id)arg1 withContext:(const struct TITokenID { unsigned int x1; unsigned int x2; }*)arg2 contextLength:(unsigned long long)arg3 saveToDifferentialPrivacy:(int)arg4 contextStringTokens:(id)arg5;
...
- (unsigned long long)fillTokenIDBuffer:(struct TITokenID { unsigned int x1; unsigned int x2; }*)arg1 withContextForTokenAtIndex:(unsigned long long)arg2 contextStringsBuffer:(id)arg3;
...
- (void)rejectToken:(id)arg1 withContext:(const struct TITokenID { unsigned int x1; unsigned int x2; }*)arg2 contextLength:(unsigned long long)arg3 contextStringTokens:(id)arg4 negativeLearningHint:(int)arg5 withRevisedToken:(id)arg6;

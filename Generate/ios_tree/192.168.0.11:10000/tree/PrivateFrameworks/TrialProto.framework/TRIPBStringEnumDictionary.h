...
@interface TRIPBStringEnumDictionary : NSObject <NSCopying, TRIPBDictionaryInternalsProtocol> {
...
- (id)initWithValidationFunction:(int (*)arg1 rawValues:(const int*)arg2 forKeys:(id*)arg3 count:(unsigned long long)arg4;

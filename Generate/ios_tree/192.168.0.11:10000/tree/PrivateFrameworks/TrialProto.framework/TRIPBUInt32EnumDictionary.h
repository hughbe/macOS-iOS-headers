...
@interface TRIPBUInt32EnumDictionary : NSObject <NSCopying, TRIPBDictionaryInternalsProtocol> {
...
- (id)initWithValidationFunction:(int (*)arg1 rawValues:(const int*)arg2 forKeys:(const unsigned int*)arg3 count:(unsigned long long)arg4;

...
@interface TRIPBInt32EnumDictionary : NSObject <NSCopying, TRIPBDictionaryInternalsProtocol> {
...
- (id)initWithValidationFunction:(int (*)arg1 rawValues:(const int*)arg2 forKeys:(const int*)arg3 count:(unsigned long long)arg4;

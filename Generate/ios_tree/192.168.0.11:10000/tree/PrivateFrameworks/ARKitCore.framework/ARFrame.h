...
@interface ARFrame : NSObject <NSCopying, NSSecureCoding> {
    ...
    struct __CVBuffer { } * _spatialMappingDepthBuffer;
    double  _timestamp;
...
@property (nonatomic) struct __CVBuffer { }*spatialMappingDepthBuffer;
...
- (void)setSpatialMappingDepthBuffer:(struct __CVBuffer { }*)arg1;
...
- (struct __CVBuffer { }*)spatialMappingDepthBuffer;
- (double)timestamp;
- (id)timingData;

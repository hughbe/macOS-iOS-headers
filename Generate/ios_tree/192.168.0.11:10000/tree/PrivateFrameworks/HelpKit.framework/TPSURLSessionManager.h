...
- (id)delegate;
- (id)init;
- (id)newURLSessionItemWithRequest:(id)arg1 identifier:(id)arg2 attributionIdentifier:(id)arg3 completionHandler:(id /* block */)arg4;
- (id)newURLSessionItemWithRequest:(id)arg1 identifier:(id)arg2 attributionIdentifier:(id)arg3 networkDelegate:(id)arg4 completionHandler:(id /* block */)arg5;

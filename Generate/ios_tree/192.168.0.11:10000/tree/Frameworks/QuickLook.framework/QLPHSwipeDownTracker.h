...
@property (nonatomic, readonly) struct QLPHDisplayVelocity { double x1; double x2; double x3; double x4; } trackedVelocity;
...
- (struct QLPHDisplayVelocity { double x1; double x2; double x3; double x4; })trackedVelocity;

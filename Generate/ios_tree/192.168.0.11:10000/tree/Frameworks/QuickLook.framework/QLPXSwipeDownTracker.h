...
@property (nonatomic, retain) QLPXInitialHysteresisNumberFilter *horizontalTranslationFilter;
...
@property (nonatomic) struct QLPXDisplayVelocity { double x1; double x2; double x3; double x4; } trackedVelocity;
@property (nonatomic, retain) QLPXChangeDirectionNumberFilter *verticalDirectionFilter;
...
- (void)setTrackedVelocity:(struct QLPXDisplayVelocity { double x1; double x2; double x3; double x4; })arg1;
...
- (struct QLPXDisplayVelocity { double x1; double x2; double x3; double x4; })trackedVelocity;

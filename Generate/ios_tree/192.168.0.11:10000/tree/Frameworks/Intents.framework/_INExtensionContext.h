...
@interface _INExtensionContext : NSExtensionContext <INIntentDelivererDataSource, INIntentDelivererDelegate, _INExtensionContextVending> {
...
@property (nonatomic, readonly) INIntentDeliverer *_intentDeliverer;

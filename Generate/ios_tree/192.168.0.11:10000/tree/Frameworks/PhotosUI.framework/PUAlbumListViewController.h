...
@interface PUAlbumListViewController : UIViewController <PLCloudFeedNavigating, PUAlbumListTableViewCellDelegate, PUAlbumStreamActivityDelegate, PUCollectionViewReorderDelegate, PUCollectionsCollectionViewDropDataProvider, PUSectionedGridLayoutDelegate, PUStackedAlbumControllerTransition, PUStackedAlbumTransitionDelegate, PXAssetCollectionActionPerformerDelegate, PXCollectionsDataSourceManagerObserver, PXEditableNavigationTitleViewDelegate, PXForcedDismissableViewController, PXNavigableCollectionContainer, PXNavigableSharedAlbumActivityFeedHostViewController, PXPhotoLibraryUIChangeObserver, PXPlacesSnapshotFactoryDelegate, PXSettingsKeyObserver, UICollectionViewDataSource, UICollectionViewDelegate, UIGestureRecognizerDelegate, UIPopoverPresentationControllerDelegate, UITableViewDataSource, UITableViewDelegate> {

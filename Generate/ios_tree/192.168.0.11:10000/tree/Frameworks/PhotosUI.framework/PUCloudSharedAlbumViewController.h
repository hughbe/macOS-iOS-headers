...
@interface PUCloudSharedAlbumViewController : PUPhotosAlbumViewController <PXAlbumStreamingOptionsViewControllerDelegate, PXAssetsSharingHelperDelegate, PXPhotoStreamComposeServiceDelegate, PXVideoTrimQueueControllerDelegate, UIPopoverPresentationControllerDelegate> {

...
@interface PUImportViewController : PUPhotosGridViewController <PUCameraImportItemCellDelegate, PUImportActionCoordinatorDelegate, PUImportAddToAlbumsToolbarViewDelegate, PUImportOneUpTransitioning, PUImportSectionedGridLayoutDelegate, PUSectionedGridLayoutDelegate, PXChangeObserver, PXImportAlbumPickerDelegate, PXImportAssetsDataSourceManagerObserver, PXImportControllerImportCompletionDelegate, PXImportControllerNotificationsReceiver, PXImportHistorySectionHeaderViewDelegate, PXSettingsKeyObserver, PXSwipeSelectionManagerDelegate, UIGestureRecognizerDelegate, UIPopoverPresentationControllerDelegate> {

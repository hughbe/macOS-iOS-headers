...
@interface PUUIImageViewController : PLUIImageViewController <PUPhotoPickerSelectionHandler, PUPhotoPickerServicesConsumer, PUVideoPlayerViewDelegate, PXChangeObserver, UIGestureRecognizerDelegate> {

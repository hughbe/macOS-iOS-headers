...
@property (nonatomic, readonly) NSDictionary *homePodsInRooms;
@property (nonatomic, readonly) NSDictionary *homePodsInZones;
...
@property (nonatomic, readonly) NSArray *homePodsWithAnnounceEnabledInRooms;
@property (nonatomic, readonly) NSArray *homePodsWithAnnounceEnabledInZones;
@property (nonatomic, readonly) NSArray *homePodsWithAnnounceSupportedInRooms;
@property (nonatomic, readonly) NSArray *homePodsWithAnnounceSupportedInZones;
...
@property (nonatomic, readonly) NSArray *roomIdentifiers;
@property (nonatomic, readonly) NSArray *roomsInZones;
@property (nonatomic, readonly) NSArray *roomsWithHomePods;
...
@property (nonatomic, readonly) NSArray *zoneIdentifiers;
@property (nonatomic, readonly) NSArray *zonesWithHomePods;
...
- (id)homePodsWithAnnounceEnabledInRooms;
- (id)homePodsWithAnnounceEnabledInZones;
- (id)homePodsWithAnnounceSupportedInRooms;
- (id)homePodsWithAnnounceSupportedInZones;
...
- (id)roomIdentifiers;
- (id)roomsInZones;
- (id)roomsWithHomePods;
- (id)unplayedAnnouncements;
- (id)userIdentifiers;
- (id)zoneIdentifiers;
- (id)zonesWithHomePods;

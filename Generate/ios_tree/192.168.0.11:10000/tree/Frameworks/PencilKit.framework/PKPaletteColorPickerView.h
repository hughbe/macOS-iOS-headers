...
@interface PKPaletteColorPickerView : UIView <PKEdgeLocatable, PKPaletteColorPickerControllerDelegate, PKPalettePopoverDismissing, PKPalettePopoverUpdating, PKPaletteQuickColorPicking, PKPaletteViewSizeScaling, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UIGestureRecognizerDelegate, UIPopoverPresentationControllerDelegate> {

...
@interface PKTextInputPaletteController : NSObject <PKPaletteControllerDelegate, PKPaletteTapToRadarCommandDelegate, PKTextInputWindowFirstResponderControllerDelegate> {

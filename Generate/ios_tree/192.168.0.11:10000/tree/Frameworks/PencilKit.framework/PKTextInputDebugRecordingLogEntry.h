...
+ (id)_dictionaryRepresentationForTargetContentInfo:(id)arg1 elementType:(id)arg2 detailLevel:(long long)arg3 contentLevel:(long long)arg4 resultAffectedRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg5 localeIdentifier:(id)arg6;

...
- (id)fileURL;
- (id)generationData;
- (id)initWithMaximumSize:(struct CGSize { double x1; double x2; })arg1 minimumSize:(double)arg2 scale:(double)arg3 badgeType:(unsigned long long)arg4 fileURL:(id)arg5 generationData:(id)arg6;

...
+ (id)_typeRecordWithContext:(struct LSContext { id x1; }*)arg1 identifier:(id)arg2;
+ (id)enumerator;
...
- (void)_enumerateRelatedTypesWithContext:(struct LSContext { id x1; }*)arg1 unitID:(unsigned int)arg2 maximumDegreeOfSeparation:(long long)arg3 block:(id /* block */)arg4;

...
@interface EKICSImporter : NSObject {
    ...
    id /* block */  _shouldImportContinueGivenDecision;
    NSMutableArray * _vCalFilesToImport;
}

@property (nonatomic, retain) NSArray *allCalendarUIDs;
@property (nonatomic, retain) NSArray *allSourceUIDs;
...
@property (nonatomic, copy) id /* block */ shouldImportContinueGivenDecision;
...
- (void)setAllCalendarUIDs:(id)arg1;
- (void)setAllSourceUIDs:(id)arg1;
...
- (void)setShouldImportContinueGivenDecision:(id /* block */)arg1;
- (void)setVCalFilesToImport:(id)arg1;
- (id /* block */)shouldImportContinueGivenDecision;

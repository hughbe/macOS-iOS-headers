...
@interface CNContactPhotoView : UIControl <CNAvatarViewDelegate, CNPhotoPickerViewControllerDelegate, CNPresenterDelegate, QLPreviewControllerDataSource, QLPreviewControllerDelegate, UIDropInteractionDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate> {

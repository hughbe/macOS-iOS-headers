...
@property (nonatomic, retain) NSMutableArray *pendingRequestContexts;
...
- (void)initiateDeleteChildSPI:(id)arg1 remoteSPI:(id)arg2 deleteCompletionCallback:(id /* block */)arg3;
...
- (void)resendPreviousMOBIKEInnerWithRetries:(unsigned int)arg1 retryInterval:(unsigned long long)arg2 handler:(id /* block */)arg3;
- (void)resetAll;
...
- (int)sendRequest:(id)arg1 retryIntervalInMilliseconds:(unsigned long long)arg2 maxRetries:(unsigned int)arg3 timeoutError:(id)arg4 resend:(bool)arg5 sendMessageID:(int)arg6 sendCompletionHandler:(id /* block */)arg7 replyHandler:(id /* block */)arg8;
- (id)sendTimer;
- (id)sentReplies;
- (id)sentRequests;
...
- (void)setPendingRequestContexts:(id)arg1;

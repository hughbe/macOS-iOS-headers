...
@interface HMHomeManager : NSObject <HFStateDumpBuildable, HMApplicationData, HMFLogging, HMFMessageReceiver, HMFTimerDelegate, HMMutableApplicationData> {
...
- (void)launchSetupViewController:(id)arg1 completionHandler:(id /* block */)arg2;

...
@interface MKPlacePhotoGalleryViewController : UIViewController <MKActivityObserving, UIGestureRecognizerDelegate, UIScrollViewDelegate> {
...
@property (nonatomic, retain) UIBarButtonItem *addPhotoBarButtonItem;
...
@property (nonatomic, retain) UIBarButtonItem *rapBarButton;
...
- (void)setAddPhotoBarButtonItem:(id)arg1;

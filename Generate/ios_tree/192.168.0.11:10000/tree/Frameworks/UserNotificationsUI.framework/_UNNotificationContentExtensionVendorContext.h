...
@interface _UNNotificationContentExtensionVendorContext : NSExtensionContext <_UNNotificationExtensionHostInterface, _UNNotificationExtensionVendorInterface> {
    ...
    <_UNNotificationContentExtensionContainer> * _notificationExtensionContainer;
...
@property (nonatomic) <_UNNotificationContentExtensionContainer> *notificationExtensionContainer;

...
- (oneway void)generateClipWithSeconds:(double)arg1 handler:(id /* block */)arg2;
...
- (oneway void)macApplicationDidBecomeActiveWithContextID:(unsigned int)arg1 completionHandler:(id /* block */)arg2;
...
- (oneway void)resumeInAppBroadcastWithWindowLayerContextID:(unsigned int)arg1 completionHandler:(id /* block */)arg2;
- (oneway void)resumeInAppCaptureWithWindowLayerContextID:(unsigned int)arg1 completionHandler:(id /* block */)arg2;
- (oneway void)resumeInAppRecordingWithWindowLayerContextID:(unsigned int)arg1 completionHandler:(id /* block */)arg2;
...
- (oneway void)startClipBufferingWithMicrophoneEnabled:(bool)arg1 windowSize:(struct CGSize { double x1; double x2; })arg2 withHandler:(id /* block */)arg3;
...
- (oneway void)stopClipBufferingWithHandler:(id /* block */)arg1;

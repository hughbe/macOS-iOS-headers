...
@interface PDSCoordinator : NSObject <IDSPushHandlerDelegate, PDSEntryStoreDelegate, PDSRequestQueueDelegate> {
...
- (id)heartbeatTimer;
- (id)initWithQueue:(id)arg1 serverBag:(id)arg2 requestQueue:(id)arg3 kvStoreBlock:(id /* block */)arg4 entryStoreBlock:(id /* block */)arg5 pushTokenBlock:(id /* block */)arg6;

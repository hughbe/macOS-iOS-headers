...
@property (nonatomic, readonly) struct _HistoryStreamedMatchEntry { struct { unsigned int x_1_1_1; unsigned int x_1_1_2; } x1; char *x2; char *x3; float x4; }*streamData;
...
- (struct _HistoryStreamedMatchEntry { struct { unsigned int x_1_1_1; unsigned int x_1_1_2; } x1; char *x2; char *x3; float x4; }*)streamData;
- (id)title;
- (float)topSitesScore;
- (id)url;

...
@property (nonatomic, readonly, retain) NSArray *orderedStrokes;
@property (nonatomic, readonly, retain) NSArray *orderedStrokesGroup1;
@property (nonatomic, readonly, retain) NSArray *orderedStrokesGroup2;
@property (nonatomic, readonly, retain) NSArray *strokeGroup1;
@property (nonatomic, readonly, retain) NSArray *strokeGroup2;

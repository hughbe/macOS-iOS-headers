...
- (void)_exchangeAuthCode:(id)arg1 codeVerifier:(id)arg2 forTokensAndUsernameWithCompletion:(id /* block */)arg3;
- (void)_exchangeAuthCode:(id)arg1 codeVerifier:(id)arg2 forTokensWithCompletion:(id /* block */)arg3;
...
- (id)clientID;
- (id)easEndPoint;
- (void)exchangeAuthCode:(id)arg1 codeVerifier:(id)arg2 forTokensAndUsernameWithCompletion:(id /* block */)arg3;

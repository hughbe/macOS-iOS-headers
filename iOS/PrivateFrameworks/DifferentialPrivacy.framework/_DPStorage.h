...
- (id)coredataStorage;
- (void)dealloc;
- (void)deleteAllRecordsByKey:(id)arg1 withCompletion:(id /* block */)arg2;
...
- (void)fetchRecordsFor:(id)arg1 predicate:(id)arg2 fetchLimit:(unsigned long long)arg3 fetchOffset:(unsigned long long)arg4 randomizeOrder:(bool)arg5 withCompletion:(id /* block */)arg6;

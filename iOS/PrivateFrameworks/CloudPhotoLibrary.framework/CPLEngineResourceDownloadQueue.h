...
- (id)_downloadTaskForLocalResource:(id)arg1 clientBundleID:(id)arg2 intent:(unsigned long long)arg3 proposedTaskIdentifier:(id)arg4 didStartHandler:(id /* block */)arg5 progressHandler:(id /* block */)arg6 completionHandler:(id /* block */)arg7;
- (void)_enqueueTransferTaskInActiveQueue:(id)arg1;
- (id)_failedTaskWithCompletionHandler:(id /* block */)arg1 error:(id)arg2 resource:(id)arg3 taskIdentifier:(id)arg4 intent:(unsigned long long)arg5;
- (bool)_launchTransportTaskForQueue:(id)arg1;
- (id)_queuesStatus;
- (id)_realDownloadTaskForLocalResource:(id)arg1 taskIdentifier:(id)arg2 cloudResource:(id)arg3 didStartHandler:(id /* block */)arg4 progressHandler:(id /* block */)arg5 completionHandler:(id /* block */)arg6;
- (void)_requestBackgroundDownloads;
- (id)_resourceStorageCopyTaskForResource:(id)arg1 taskIdentifier:(id)arg2 cloudResource:(id)arg3 didStartHandler:(id /* block */)arg4 progressHandler:(id /* block */)arg5 completionHandler:(id /* block */)arg6;
...
- (id)downloadTaskForLocalResource:(id)arg1 clientBundleID:(id)arg2 intent:(unsigned long long)arg3 proposedTaskIdentifier:(id)arg4 didStartHandler:(id /* block */)arg5 progressHandler:(id /* block */)arg6 completionHandler:(id /* block */)arg7;

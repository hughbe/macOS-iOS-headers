...
- (bool)_addDetectedObjectsInfo:(id)arg1 toSampleBuffer:(struct opaqueCMSampleBuffer { }*)arg2;
- (bool)_addFacesArray:(id)arg1 toSampleBuffer:(struct opaqueCMSampleBuffer { }*)arg2;
...
- (unsigned long long)append:(id)arg1 toBoxedData:(char *)arg2 localIDs:(unsigned int*)arg3 isFace:(bool)arg4;

...
- (int)_appendFilteredPreviewPipeline:(id*)arg1 desiredPipelineStage:(id)arg2 videoPreviewSinkConnectionConfiguration:(id)arg3 graph:(id)arg4 inferenceScheduler:(id)arg5 captureDevice:(id)arg6 depthFromMonocularNetworkEnabled:(bool)arg7;

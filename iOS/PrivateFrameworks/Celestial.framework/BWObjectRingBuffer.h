...
- (void)_checkAscendingInsertAt:(int)arg1 object:(id)arg2 forTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg3;
...
- (struct { long long x1; int x2; unsigned int x3; long long x4; })getTimeForIndex:(int)arg1;

...
@property (readonly) struct { int x1; int x2; } spatialOverCaptureHighResStillImageDimensions;
...
- (struct { int x1; int x2; })spatialOverCaptureHighResStillImageDimensions;

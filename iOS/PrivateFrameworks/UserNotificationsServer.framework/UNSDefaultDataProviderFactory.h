...
- (void)_queue_updateSettingsWithAuthorizationStatus:(long long)arg1 options:(unsigned long long)arg2 expirationDate:(id)arg3 lastUserGrantDate:(id)arg4 forNotificationSourceDescription:(id)arg5 completionHandler:(id /* block */)arg6;
...
- (void)requestAuthorizationStatus:(long long)arg1 withOptions:(unsigned long long)arg2 expirationDate:(id)arg3 lastUserGrantDate:(id)arg4 forNotificationSourceDescription:(id)arg5 completionHandler:(id /* block */)arg6;

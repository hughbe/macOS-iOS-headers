...
- (bool)_saveEntityEvents:(id)arg1 maxRetries:(long long)arg2 retryInterval:(double)arg3 shouldContinueBlock:(id /* block */)arg4;
- (bool)_saveTopicEvents:(id)arg1;
- (bool)_saveTopicEvents:(id)arg1 maxRetries:(long long)arg2 retryInterval:(double)arg3 shouldContinueBlock:(id /* block */)arg4;

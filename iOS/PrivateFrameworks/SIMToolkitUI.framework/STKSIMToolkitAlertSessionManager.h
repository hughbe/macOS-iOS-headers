...
@interface STKSIMToolkitAlertSessionManager : STKAlertSessionManager <SBSRemoteAlertHandleObserver, STKIncomingCallUIStateObserver, STKUserEventMonitorDelegate> {

...
@property (nonatomic, retain) NAFuture *userNotificationCenterReadyFuture;
...
- (void)setUserNotificationCenterReadyFuture:(id)arg1;
...
- (id)userNotificationCenterReadyFuture;

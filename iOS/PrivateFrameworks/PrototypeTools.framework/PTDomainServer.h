...
@interface PTDomainServer : NSObject <NSXPCListenerDelegate, PTDomainServer, PTEditingServerDataSource, PTEditingServerDelegate, PTSettingsKeyPathObserver, _PTSettingsRestoreDefaultsObserver> {

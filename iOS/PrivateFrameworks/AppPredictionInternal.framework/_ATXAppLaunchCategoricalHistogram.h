...
@interface _ATXAppLaunchCategoricalHistogram : NSObject <ATXActionKeyRemovableProtocol, ATXBundleIdRemovableProtocol, NSSecureCoding, _ATXAppLaunchHistogramProtocol> {

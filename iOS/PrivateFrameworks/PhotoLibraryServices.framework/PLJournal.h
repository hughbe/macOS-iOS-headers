...
+ (bool)_performSnapshotsForBaseURL:(id)arg1 snapshotMode:(unsigned char)arg2 payloadClasses:(id)arg3 snapshotJournalBlock:(id /* block */)arg4 error:(id*)arg5;
...
+ (bool)createSnapshotsForBaseURL:(id)arg1 payloadClasses:(id)arg2 snapshotJournalBlock:(id /* block */)arg3 error:(id*)arg4;
...
- (bool)_performSnapshotWithMode:(unsigned char)arg1 usingNextEntryBlock:(id /* block */)arg2 error:(id*)arg3;

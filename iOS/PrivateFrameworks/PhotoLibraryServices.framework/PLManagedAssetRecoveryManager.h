...
@property (nonatomic, retain) PLPhotoLibrary *syncablePhotoLibrary;
...
- (void)_fixMissingFullSizeAdjustedResources:(id)arg1 cloudPhotoLibraryManager:(id)arg2 recoveryState:(unsigned long long)arg3 completionBlock:(id /* block */)arg4;
...
- (void)_generateMissingFullSizeAdjustedResourcesForAsset:(id)arg1 recipesToGenerate:(id)arg2 cloudPhotoLibraryManager:(id)arg3 recoveryState:(unsigned long long)arg4 completionBlock:(id /* block */)arg5;
- (id)_loadObjectWithObjectID:(id)arg1 managedObjectContext:(id)arg2;
- (void)_performAssetRecoveryTaskForInconsistentState:(id)arg1 state:(unsigned long long)arg2 cloudPhotoLibraryManager:(id)arg3 completionBlock:(id /* block */)arg4;
...
- (void)_recoverNextRecoveryState:(id)arg1 forAsset:(id)arg2 cloudPhotoLibraryManager:(id)arg3 completionBlock:(id /* block */)arg4;
...
- (void)setSyncablePhotoLibrary:(id)arg1;

...
@interface HKSHQuickScheduleOverrideViewController : UITableViewController <HKSHScheduleOccurrenceAlarmVolumeTableViewCellHandler, HKSHScheduleOccurrenceComponentsAccessibilityTableViewCellDelegate, HKSHSleepScheduleComponentsEditViewHandling, HKSwitchTableViewCellDelegate, TKTonePickerViewControllerDelegate, TKVibrationPickerViewControllerDelegate> {
    void alarmConfigurationObserver;
    void alarmPreviewPlayer;
    void dataSource;
    void delegate;
    void eventRecordChangeObserver;
    void model;

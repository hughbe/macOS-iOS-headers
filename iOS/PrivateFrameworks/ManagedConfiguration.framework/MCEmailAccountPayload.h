...
@property (nonatomic, retain) NSString *incomingACAccountIdentifier;
...
@property (nonatomic, retain) NSString *outgoingACAccountIdentifier;
...
- (void)setIncomingACAccountIdentifier:(id)arg1;
- (void)setOutgoingACAccountIdentifier:(id)arg1;
- (id)stubDictionary;

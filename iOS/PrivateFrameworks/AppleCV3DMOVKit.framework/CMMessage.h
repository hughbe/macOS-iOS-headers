...
@property (nonatomic, retain) PRCollaborationData *prCollaborationData;
@property (nonatomic, retain) PRPeer *prPeer;
...
- (void)setPrCollaborationData:(id)arg1;
- (void)setPrPeer:(id)arg1;

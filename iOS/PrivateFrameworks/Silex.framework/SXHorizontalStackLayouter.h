...
- (struct CGSize { double x1; double x2; })calculateSizeForContainerComponentWithBlueprint:(id)arg1 width:(double)arg2 layoutContext:(id)arg3 layoutDescription:(id)arg4 shouldContinue:(bool*)arg5;

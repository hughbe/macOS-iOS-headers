...
@interface BWUBNode : BWNode <BWAdaptiveBracketingController, BWDeepFusionProcessorControllerDelegate, BWDeferredProcessorControllerDelegate, BWNoiseReductionAndFusionProcessorDelegate, BWStillImageProcessingSupportProvider, BWUBInferenceControllerDelegate> {
...
- (void)commitDeferredSkinMask:(struct __CVBuffer { }*)arg1 skyMask:(struct __CVBuffer { }*)arg2 personMask:(struct __CVBuffer { }*)arg3 faceObservations:(id)arg4 processorInput:(id)arg5;

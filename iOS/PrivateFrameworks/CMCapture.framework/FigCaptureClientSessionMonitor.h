...
- (id)_initWithClientAuditToken:(struct { unsigned int x1[8]; })arg1 forThirdPartyTorch:(bool)arg2 avconferenceClientApplicationIDs:(id)arg3 applicationAndLayoutStateHandler:(id /* block */)arg4 interruptionHandler:(id /* block */)arg5;

...
- (int)_buildMetadataObjectRemoteQueueSinkPipeline:(id)arg1 graph:(id)arg2 metadataNodeOutputs:(id)arg3 videoPreviewEnabled:(bool)arg4 deferredPrepareEnabled:(bool)arg5 delegate:(id)arg6 clientAuditToken:(struct { unsigned int x1[8]; })arg7;
- (int)_buildMetadataSinkPipeline:(id)arg1 graph:(id)arg2 videoPreviewOutput:(id)arg3 offlineVISMotionDataSourceOutput:(id)arg4 objectDetectionSourceOutput:(id)arg5 faceTrackingSourceOutput:(id)arg6 captureDevice:(id)arg7 faceTrackingPipelineStage:(id)arg8 clientAuditToken:(struct { unsigned int x1[8]; })arg9 delegate:(id)arg10;
...
- (id)initWithConfiguration:(id)arg1 graph:(id)arg2 name:(id)arg3 videoPreviewOutput:(id)arg4 offlineVISMotionDataSourceOutput:(id)arg5 objectDetectionSourceOutput:(id)arg6 faceTrackingSourceOutput:(id)arg7 captureDevice:(id)arg8 faceTrackingPipelineStage:(id)arg9 clientAuditToken:(struct { unsigned int x1[8]; })arg10 delegate:(id)arg11;

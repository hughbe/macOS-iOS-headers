...
@property (nonatomic, readonly) CPUIPlayModeButton *addToLibraryButton;
...
@property (nonatomic, readonly) CPUIPlayModeButton *moreButton;
@property (nonatomic, readonly) CPUIPlayModeButton *playbackRateButton;
@property (nonatomic, readonly) CPUIRepeatButton *repeatButton;
@property (nonatomic) bool showsArtwork;
@property (nonatomic, readonly) CPUIPlayModeButton *shuffleButton;

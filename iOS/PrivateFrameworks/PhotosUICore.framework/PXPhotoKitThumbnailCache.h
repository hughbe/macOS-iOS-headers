...
- (void)cacheThumbnailData:(id)arg1 specification:(const struct PHAssetResourceTableDataSpecification { int x1; int x2; int x3; int x4; int x5; int x6; }*)arg2 forAsset:(id)arg3;
- (void)dealloc;
- (id)description;
- (id)init;

...
@property (nonatomic, retain) UIViewController *interactionPreviewViewController;
...
- (id)interactionPreviewViewController;
...
- (void)setInteractionPreviewViewController:(id)arg1;

...
@interface PXGPPTVideoPlaybackViewController : PXGPPTViewController <PXGDisplayAssetPixelBufferSourcesProvider, PXGDisplayAssetSource, PXGSolidColorSource, PXGSublayoutProvider> {

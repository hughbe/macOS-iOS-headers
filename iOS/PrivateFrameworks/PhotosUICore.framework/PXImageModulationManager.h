...
+ (struct { long long x1; float x2; float x3; })optionsForAsset:(id)arg1;

- (void).cxx_destruct;
- (double)HDRFocus;
- (void)_applicationDidBecomeActive:(id)arg1;
- (void)_applicationDidResignActive:(id)arg1;
- (id)_checkoutImageLayerModulatorWithOptions:(struct { long long x1; float x2; float x3; })arg1 contentType:(long long)arg2;
...
- (id)checkoutImageLayerModulatorWithOptions:(struct { long long x1; float x2; float x3; })arg1;
- (id)checkoutLivePhotoViewModulatorWithOptions:(struct { long long x1; float x2; float x3; })arg1;

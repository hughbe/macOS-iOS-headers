...
@property (nonatomic) struct NSEdgeInsets { double x1; double x2; double x3; double x4; } titleEdgeInsets;
...
- (void)setTitleEdgeInsets:(struct NSEdgeInsets { double x1; double x2; double x3; double x4; })arg1;
...
- (struct NSEdgeInsets { double x1; double x2; double x3; double x4; })titleEdgeInsets;

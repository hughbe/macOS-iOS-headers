...
- (id)privateGetID;
- (struct PortDescriptionImpl { id x1; id x2; id x3; id x4; id x5; bool x6; bool x7; bool x8; unsigned long long x9; id x10; id x11; id x12; id x13; }*)privateGetImplementation;

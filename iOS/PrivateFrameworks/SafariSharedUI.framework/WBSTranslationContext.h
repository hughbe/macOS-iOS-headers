...
- (id)_currentSession;
- (id)_currentSnapshot;
- (void)_dominantLocaleForTextSample:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)_generateJSONVersionOfContent:(id)arg1 prettyPrinted:(bool)arg2 completionHandler:(id /* block */)arg3;

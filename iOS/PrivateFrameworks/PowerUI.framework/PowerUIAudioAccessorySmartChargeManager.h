...
@interface PowerUIAudioAccessorySmartChargeManager : NSObject <NSXPCListenerDelegate, PowerUISignalMonitorDelegate, PowerUISmartChargeManagingAudioAccessories, PowerUISmartChargeManagingAudioAccessoriesPrivate, UNUserNotificationCenterDelegate> {
...
@property (nonatomic) struct BTSessionImpl { }*session;

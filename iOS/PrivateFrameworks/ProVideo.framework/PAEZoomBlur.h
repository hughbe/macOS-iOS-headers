...
- (void)constrainWidth:(unsigned long long*)arg1 andHeight:(unsigned long long*)arg2 withImageInfo:(struct { unsigned long long x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; unsigned long long x5; unsigned long long x6; unsigned long long x7; bool x8; double x9; })arg3;
- (void)dealloc;
...
- (void)polarToRect:(id)arg1 withInputImage:(id)arg2 withInputNode:(struct HGRef<HGNode> { struct HGNode {} *x1; })arg3 centerX:(double)arg4 centerY:(double)arg5 andOutputNode:(struct HGRef<HGNode> { struct HGNode {} *x1; }*)arg6;
- (id)properties;
- (void)rectToPolar:(id)arg1 withInputImage:(id)arg2 withInputNode:(struct HGRef<HGNode> { struct HGNode {} *x1; })arg3 centerX:(double)arg4 centerY:(double)arg5 andOutputNode:(struct HGRef<HGGLBlend> { struct HGGLBlend {} *x1; }*)arg6;

...
- (void)fetchAgencyModelForRegionCode:(id)arg1 completion:(id /* block */)arg2;
...
- (void)isShareStatisticsEnabledForRegion:(id)arg1 completion:(id /* block */)arg2;
...
- (void)setShareStatisticsEnabled:(bool)arg1 region:(id)arg2 completion:(id /* block */)arg3;

...
- (void)profilePictureForAccountOwnerWithoutMonogramFallbackWithPictureDiameter:(double)arg1 completion:(id /* block */)arg2;
- (id)profilePictureStore;
- (void)profilePictureStoreDidChange:(id)arg1;
- (void)profilePictureWithMonogramFallbackForFamilyMember:(id)arg1 pictureDiameter:(double)arg2 completion:(id /* block */)arg3;

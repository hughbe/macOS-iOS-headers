...
@property (nonatomic, retain) SSTrialManager *trialModelManager;
...
- (bool)loadModels;
- (bool)loadModelsFromTrialWithCompletion:(id /* block */)arg1;
- (id)modelType;
- (id)modelVersion;
- (id)models;

...
- (void)invokeClientDownloadCompletion:(long long)arg1 completionBlockWithError:(id /* block */)arg2;
- (void)invokeClientDownloadCompletionAlreadyOnQueue:(long long)arg1 completionBlockWithError:(id /* block */)arg2;

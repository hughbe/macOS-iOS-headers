...
@property (nonatomic, retain) NPLocation *cachedLocation;
...
@property (nonatomic, retain) NPWaldo *defaults;
...
@property (nonatomic, retain) NPKeyBag *keybag;
...
@property (nonatomic, retain) NSDate *locationCheckTimestamp;
@property (nonatomic, retain) NSDate *locationExpiration;
@property (nonatomic, retain) NPWaldoLocationManager *locationManager;
...
- (bool)isEndpointProbed:(id)arg1 parameters:(struct networkParameters { bool x1; bool x2; }*)arg2 latencies:(id)arg3 checkSampleSize:(bool)arg4 incompleteLatency:(id*)arg5;
- (bool)isIPv6Enabled;

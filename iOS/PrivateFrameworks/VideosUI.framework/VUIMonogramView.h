...
@interface VUIMonogramView : _UIFloatingContentView <TVAuxiliaryViewSelecting, _UIFloatingContentViewDelegate> {
...
@property (nonatomic, readonly) VUIMonogramViewConfiguration *configuration;

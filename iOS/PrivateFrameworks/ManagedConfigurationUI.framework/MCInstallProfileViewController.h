...
@interface MCInstallProfileViewController : MCUIViewController <DevicePINControllerDelegate, MCInstallationConsentDelegate, MCInstallationWarningDelegate, MCProfileQuestionsControllerDelegate, MCProfileViewControllerDelegate, MCUISignInViewControllerDelegate, UIAdaptivePresentationControllerDelegate> {
...
- (void)_installProfileOnWatchWithCompletion:(id /* block */)arg1;

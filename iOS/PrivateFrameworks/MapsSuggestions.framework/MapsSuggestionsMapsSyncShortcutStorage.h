...
@interface MapsSuggestionsMapsSyncShortcutStorage : NSObject <MapsSuggestionsShortcutStorage, MapsSync.MapsSyncDataQueryDelegate, MapsSync.MapsSyncDataQueryMergeDelegate> {
...
@property (nonatomic, retain) _TtC8MapsSync25MapsSyncFavoriteItemQuery *query;

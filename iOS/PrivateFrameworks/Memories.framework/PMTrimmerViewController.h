...
@interface PMTrimmerViewController : UIViewController <UIMovieScrubberDataSource, UIMovieScrubberDelegate> {
...
@property (nonatomic, retain) PMTrimmerDebugView *debugOverlay;
@property (nonatomic) double deferredSeekTime;
@property (nonatomic) <PMTrimmerDelegate> *delegate;
...
@property (nonatomic, retain) NSMutableArray *otherRangeLayers;
...
@property (nonatomic, retain) PMScrubberImageSource *thumbnailSource;
...
- (void)setOtherRangeLayers:(id)arg1;

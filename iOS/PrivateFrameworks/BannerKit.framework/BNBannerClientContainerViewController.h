...
@interface BNBannerClientContainerViewController : UIViewController <_UISceneBSActionHandler, _UISceneSettingsDiffAction> {
    <BSInvalidatable> * _deferringRule;
    <BNBannerClientContainerViewControllerDelegate> * _delegate;
...
@property (nonatomic) <BNBannerClientContainerViewControllerDelegate> *delegate;

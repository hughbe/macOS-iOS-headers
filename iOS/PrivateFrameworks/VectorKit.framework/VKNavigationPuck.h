...
@interface VKNavigationPuck : NSObject <VKTrackableAnnotationPresentation> {
    ...
    struct NavigationPuck { struct PuckStyleInfo {} *x1; struct Coordinate3D<Radians, double> { struct Unit<RadianUnitDescription, double> { double x_1_2_1; } x_2_1_1; struct Unit<RadianUnitDescription, double> { double x_2_2_1; } x_2_1_2; struct Unit<MeterUnitDescription, double> { double x_3_2_1; } x_2_1_3; } x2; struct Unit<RadianUnitDescription, double> { double x_3_1_1; } x3; float x4; float x5; int x6; bool x7; bool x8; bool x9; } * _navigationPuck;
...
- (struct NavigationPuck { struct PuckStyleInfo {} *x1; struct Coordinate3D<Radians, double> { struct Unit<RadianUnitDescription, double> { double x_1_2_1; } x_2_1_1; struct Unit<RadianUnitDescription, double> { double x_2_2_1; } x_2_1_2; struct Unit<MeterUnitDescription, double> { double x_3_2_1; } x_2_1_3; } x2; struct Unit<RadianUnitDescription, double> { double x_3_1_1; } x3; float x4; float x5; int x6; bool x7; bool x8; bool x9; }*)puck;

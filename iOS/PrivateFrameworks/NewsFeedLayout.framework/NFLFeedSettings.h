...
- (id)initWithViewportSize:(struct CGSize { double x1; double x2; })arg1 viewportInsets:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg2 preferredContentSizeCategory:(id)arg3 showAccessoryText:(bool)arg4 traitCollection:(id)arg5;

...
@property (nonatomic, readonly) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } stitchedImageRect;
@property (nonatomic, readonly) struct CGSize { double x1; double x2; } stitchedImageSize;
...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })stitchedImageRect;
- (struct CGSize { double x1; double x2; })stitchedImageSize;
- (double)yawDegreeUI;
- (double)yawRadians;

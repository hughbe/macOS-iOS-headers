...
@interface ATXSuggestionLayout : NSObject <ATXProtoBufWrapper, ATXSuggestionLayoutProtocol, NSCopying, NSSecureCoding> {
...
@property (nonatomic, readonly) NSArray *fourByFourSuggestions;

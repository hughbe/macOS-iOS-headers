...
@interface ACHTinkerAwardingScheduler : NSObject <ACHAwardingScheduler, ACHTemplateStoreObserving, HDDiagnosticObject, HDHealthDaemonReadyObserver, HDPeriodicActivityDelegate> {

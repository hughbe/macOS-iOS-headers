...
@property (nonatomic, copy) NSString *airQualityLocalizedRecommendation;
@property (nonatomic, copy) NSURL *airQualityProviderURL;
...
- (id)airQualityLocalizedRecommendation;
- (id)airQualityProviderURL;
- (id)airQualityScale;
...
- (void)setAirQualityLocalizedRecommendation:(id)arg1;
- (void)setAirQualityProviderURL:(id)arg1;

...
@interface MUPDFContentViewController : MUContentViewController <MUContentViewControllerProtocol, PDFAKControllerDelegateProtocol, PDFDocumentDelegate, PDFViewDelegatePrivate, _UIViewBoundingPathChangeObserver> {
    struct UIEdgeInsets { 
        double top; 
        double left; 
        double bottom; 

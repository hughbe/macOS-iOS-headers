...
- (id)initWithContainerSize:(struct CGSize { double x1; double x2; })arg1 insets:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg2 screenScale:(double)arg3 RTL:(bool)arg4 showSideGroupPicker:(bool)arg5;

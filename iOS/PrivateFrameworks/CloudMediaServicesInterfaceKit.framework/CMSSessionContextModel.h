...
@property (nonatomic, retain) NSDictionary *serviceUpdateListeningHistoryAllUsers;
...
- (id)serviceUpdateListeningHistoryAllUsers;
...
- (void)setServiceUpdateListeningHistoryAllUsers:(id)arg1;

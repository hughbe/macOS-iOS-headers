...
- (id)initWithComposedRoute:(id)arg1 rideSelections:(id)arg2 sectionOptions:(id)arg3 decoderData:(id)arg4 tripIndex:(unsigned long long)arg5 stepRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg6 transitStepRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg7 pointRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg8;

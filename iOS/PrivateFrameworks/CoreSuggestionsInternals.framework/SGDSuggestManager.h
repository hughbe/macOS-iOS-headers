...
- (void)_suggestionsFromMessageWithIdentifier:(id)arg1 options:(unsigned long long)arg2 completion:(id /* block */)arg3 completionDelivery:(unsigned long long)arg4 providedBy:(id /* block */)arg5 dissectIfNecessary:(bool)arg6;

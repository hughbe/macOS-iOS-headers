...
@interface REMList : NSObject <REMDAChangeTrackableFetchableModel, REMDAChangedModelObjectResult, REMExternalSyncMetadataProviding, REMObjectIDProviding, REMSortingStyleReadonlyProtocol, _REMDAChangeTrackableModel> {
    REMAccount * _account;
    REMList * _parentList;

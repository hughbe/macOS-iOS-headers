...
@interface REMListChangeItem : NSObject <REMConflictResolving, REMExternalSyncMetadataWritableProviding, REMSaveRequestTrackedValue, REMSortingStyleReadWriteProtocol> {

...
- (void).cxx_destruct;
- (bool)checkIfObjectIsStaticWithBoundingBox:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 motionDetection:(id)arg2 eventType:(Class)arg3;
- (bool)containsCornersOfRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 withInsetPercentage:(float)arg2;
- (id)description;

...
- (id)metricFactory;
- (void)queryChopperDelegate:(id)arg1 fetchLinkItemModelWithURL:(id)arg2 forClientBundleID:(id)arg3 metric:(id)arg4 completion:(id /* block */)arg5;
- (void)queryChopperDelegate:(id)arg1 isBusinessRegisteredForURL:(id)arg2 forClientBundleID:(id)arg3 metric:(id)arg4 completion:(id /* block */)arg5;

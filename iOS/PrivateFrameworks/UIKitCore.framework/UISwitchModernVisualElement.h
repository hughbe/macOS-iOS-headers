...
@interface UISwitchModernVisualElement : UISwitchVisualElement <CAAnimationDelegate, UIGestureRecognizerDelegate, UISwitchMVEGestureTrackingSessionElement, _UICursorInteractionDelegate> {

...
+ (id)_batteryBodyImageWithSize:(struct CGSize { double x1; double x2; })arg1 forScale:(double)arg2 batteryRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg3 cornerRadius:(double)arg4 lineWidth:(double)arg5;
...
+ (id)_imageWithRenderedBezierPath:(id)arg1 size:(struct CGSize { double x1; double x2; })arg2 scale:(double)arg3 pathScaleFactor:(double)arg4 stroke:(bool)arg5;

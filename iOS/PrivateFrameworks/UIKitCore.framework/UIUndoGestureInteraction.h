...
@property (nonatomic, retain) UIKBProductibityDoubleTapGesture *threeFingerDoubleTap;
...
@property (nonatomic, retain) UIKBProductibitySingleTapGesture *threeFingerSingleTap;

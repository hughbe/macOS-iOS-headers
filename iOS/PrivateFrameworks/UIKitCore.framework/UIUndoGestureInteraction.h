...
@property (nonatomic, retain) UIUndoGestureObserver *observerGesture;
...
@property (nonatomic, retain) UIKBProductivityDoubleTapGesture *threeFingerDoubleTap;
@property (nonatomic, retain) UIKBProductivityLongPressGestureRecognizer *threeFingerLongPress;
@property (nonatomic, retain) UIKBProductivityPinchGestureRecognizer *threeFingerPinch;
@property (nonatomic, retain) UIKBProductivitySingleTapGesture *threeFingerSingleTap;
@property (nonatomic, retain) UIKBProductivityPanGestureRecognizer *threeFingerSlide;

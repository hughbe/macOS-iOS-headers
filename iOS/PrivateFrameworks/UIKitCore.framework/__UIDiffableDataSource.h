...
- (void)_applyDifferencesFromSnapshot:(id)arg1 viewPropertyAnimator:(id)arg2 customAnimationsProvider:(id /* block */)arg3 completion:(id /* block */)arg4;
...
- (id)_collectionView;
- (void)_commitNewDataSource:(id)arg1 withViewUpdates:(id)arg2 viewPropertyAnimator:(id)arg3 customAnimationsProvider:(id /* block */)arg4 commitAlongsideHandler:(id /* block */)arg5 completion:(id /* block */)arg6;
...
- (void)_commitUpdate:(id)arg1 snapshot:(id)arg2 completion:(id /* block */)arg3;

...
@property (nonatomic, readonly) struct { unsigned long long x1; unsigned long long x2; double x3; double x4; } menuAnchor;

- (void).cxx_destruct;
- (id)_accessoryPositionsForBaseLayout:(id)arg1;
- (unsigned long long)_automaticAlignmentForAttachment:(unsigned long long)arg1 sourcePoint:(struct CGPoint { double x1; double x2; })arg2;

...
@interface UIDragInteraction : NSObject <UIGestureRecognizerDelegate, UIInteraction, _UIDragInteractionDriverDelegate, _UIViewInternalDraggingSourceDelegate> {
    ...
    <_UIDragInteractionDriving> * _pointerInitiationDriver;
...
@property (getter=_pointerInitiationDriver, setter=_setPointerInitiationDriver:, nonatomic, retain) <_UIDragInteractionDriving> *pointerInitiationDriver;
...
- (void)_setPointerInitiationDriver:(id)arg1;

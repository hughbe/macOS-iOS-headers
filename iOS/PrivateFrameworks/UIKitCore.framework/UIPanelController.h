...
@property (setter=_setLeadingBackgroundView:, nonatomic, retain) UIVisualEffectView *_leadingBackgroundView;
...
@property (setter=_setTrailingBackgroundView:, nonatomic, retain) UIVisualEffectView *_trailingBackgroundView;

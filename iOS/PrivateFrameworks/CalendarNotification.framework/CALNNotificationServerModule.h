...
@interface CALNNotificationServerModule : NSObject <CADModule> {
    ...
    <CALNNotificationIconProvider><CALNCalendarIconIdentifierProvider> * _iconProvider;
...
@property (nonatomic, readonly) <CALNNotificationIconProvider><CALNCalendarIconIdentifierProvider> *iconProvider;

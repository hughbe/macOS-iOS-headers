...
@interface AMSUIWebViewController : UIViewController <AMSBagConsumer, AMSUIWebActionRunnerDelegate, AMSUIWebPageViewControllerDelegate, AMSUIWebProtocolDelegate, AMSURLProtocolDelegate, NSURLSessionDelegate> {

...
@interface MPCQueueController : NSObject <MPAVQueueController, MPCContinueListeningRadioQueueProviding, MPCPlaybackEngineEventObserving, MPCQueueItemProviding, MPSectionedIdentifierListAnnotationDelegate, MPShuffleableSectionedIdentifierListDelegate, MSVSegmentedCoding> {

...
@interface TRIPBBoolUInt32Dictionary : NSObject <NSCopying, TRIPBDictionaryInternalsProtocol> {
...
- (id)initWithUInt32s:(const unsigned int*)arg1 forKeys:(const bool*)arg2 count:(unsigned long long)arg3;

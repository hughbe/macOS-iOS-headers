...
@interface TRIPBUInt32BoolDictionary : NSObject <NSCopying, TRIPBDictionaryInternalsProtocol> {
...
- (id)init;
- (id)initWithBools:(const bool*)arg1 forKeys:(const unsigned int*)arg2 count:(unsigned long long)arg3;

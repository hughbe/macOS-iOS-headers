...
@interface TRIPBUInt64EnumDictionary : NSObject <NSCopying, TRIPBDictionaryInternalsProtocol> {
...
- (id)initWithValidationFunction:(int (*)arg1 rawValues:(const int*)arg2 forKeys:(const unsigned long long*)arg3 count:(unsigned long long)arg4;

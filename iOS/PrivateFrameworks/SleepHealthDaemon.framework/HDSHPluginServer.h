...
@interface HDSHPluginServer : HDStandardTaskServer <HDContentProtectionObserver, HDDiagnosticObject, HDSleepHealthDaemonPluginServerInterface> {
...
@property (getter=isSleepTrackingSessionInProgress, nonatomic) bool sleepTrackingSessionInProgress;

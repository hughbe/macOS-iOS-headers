...
@property (nonatomic, retain) NSDictionary *keyedPaywallConfigurationsByType;
@property (nonatomic, retain) NSDictionary *keyedSubscriptionButtonConfigurationsByType;

...
@property (nonatomic, readonly, copy) CKRecordZoneID *clientZoneID;
@property (nonatomic, readonly, copy) NSString *clientZoneName;
@property (nonatomic, readonly) bool isDefaultZone;
@property (nonatomic, readonly, copy) NSString *onlyClientRecordType;
@property (nonatomic, readonly, copy) NSString *onlyServerRecordType;
@property (nonatomic, readonly, copy) CKRecordZoneID *serverZoneID;
...
- (id)onlyClientRecordType;
- (id)onlyServerRecordType;

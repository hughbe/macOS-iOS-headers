...
- (void)_renderLegendPointLabelInContext:(struct CGContext { }*)arg1 point:(struct CGPoint { double x1; double x2; })arg2 untransformedPoint:(struct CGPoint { double x1; double x2; })arg3 presentationStyle:(id)arg4 leftOfPoint:(bool)arg5;

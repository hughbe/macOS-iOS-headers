...
- (void)addWaitForDataGraphSeriesContext:(id)arg1 timeScope:(long long)arg2 startDate:(id)arg3 endDate:(id)arg4 priorityDelegate:(id)arg5 completion:(id /* block */)arg6;
- (id)dataSource;

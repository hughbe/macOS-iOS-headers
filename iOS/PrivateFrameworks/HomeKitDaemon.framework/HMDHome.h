...
- (void)_enableResidentReachabilityNotification:(bool)arg1 forAccessories:(id)arg2 completionHandler:(id /* block */)arg3;
...
- (void)enableResidentReachabilityNotification:(bool)arg1 forAccessories:(id)arg2 completionHandler:(id /* block */)arg3;
- (id)enabledResidents;

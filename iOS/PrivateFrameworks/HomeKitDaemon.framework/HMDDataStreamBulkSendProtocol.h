...
- (void)_openSessionForFileType:(id)arg1 reason:(id)arg2 queue:(id)arg3 callback:(id /* block */)arg4;
...
- (void)openSessionForFileType:(id)arg1 reason:(id)arg2 queue:(id)arg3 callback:(id /* block */)arg4;

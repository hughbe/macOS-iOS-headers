...
@property (nonatomic, retain) NSMutableDictionary *updatedMediaPropertiesByMediaProfile;
...
- (void)setUpdatedMediaPropertiesByMediaProfile:(id)arg1;
- (void)timerDidFire:(id)arg1;
- (id)updatedCharacteristics;
- (id)updatedMediaPropertiesByMediaProfile;

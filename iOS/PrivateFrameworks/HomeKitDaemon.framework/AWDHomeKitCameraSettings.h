...
@property (nonatomic, retain) NSMutableArray *numPointsInActivityZonesBinStrings;
...
- (id)numPointsInActivityZonesBinStrings;
...
- (void)setNumPointsInActivityZonesBinStrings:(id)arg1;

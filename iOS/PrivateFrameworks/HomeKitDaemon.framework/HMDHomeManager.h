...
@interface HMDHomeManager : HMFObject <HAPFragmentationStreamDelegate, HMDAccessoryBrowserManagerDelegate, HMDBackingStoreObjectProtocol, HMDCloudManagerDelegate, HMDDeviceSetupSessionDelegate, HMDDuetPredictionSubscriberDataSource, HMDLogEventDailyProvider, HMDMobileAssetManagerDelegate, HMDPairedSyncDelegate, HMDSyncOperationManagerDataSource, HMDUserManagementOperationDelegate, HMFLogging, HMFMessageReceiver, HMFTimerDelegate> {
...
@property (nonatomic, retain) HMFTimer *periodicCounterLoggingTimer;
...
- (id)periodicCounterLoggingTimer;
...
- (void)setPeriodicCounterLoggingTimer:(id)arg1;

...
- (unsigned int)homeDataMegabytesFetched;
- (unsigned int)homeDataMegabytesPushed;
...
- (unsigned int)legacyHomeDataMegabytesFetched;
- (unsigned int)legacyHomeDataMegabytesPushed;
...
- (void)setHomeDataMegabytesFetched:(unsigned int)arg1;
- (void)setHomeDataMegabytesPushed:(unsigned int)arg1;
...
- (void)setLegacyHomeDataMegabytesFetched:(unsigned int)arg1;
- (void)setLegacyHomeDataMegabytesPushed:(unsigned int)arg1;

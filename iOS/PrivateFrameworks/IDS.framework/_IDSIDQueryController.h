...
- (void)_idStatusForDestinations:(id)arg1 service:(id)arg2 listenerID:(id)arg3 allowRenew:(bool)arg4 waitForReply:(bool)arg5 forceRefresh:(bool)arg6 completionBlock:(id /* block */)arg7;
...
- (bool)_refreshIDStatusForDestinations:(id)arg1 service:(id)arg2 listenerID:(id)arg3 allowRefresh:(bool)arg4 waitForReply:(bool)arg5 forceRefresh:(bool)arg6 queue:(id)arg7 completionBlock:(id /* block */)arg8;
- (void)_requestCacheForService:(id)arg1 completionBlock:(id /* block */)arg2;
- (void)_requestCachedStatusForDestinations:(id)arg1 service:(id)arg2 waitForReply:(bool)arg3 listenerID:(id)arg4 completionBlock:(id /* block */)arg5;
- (void)_requestRemoteDevicesForDestination:(id)arg1 service:(id)arg2 listenerID:(id)arg3 completionBlock:(id /* block */)arg4;
- (void)_requestStatusForDestinations:(id)arg1 service:(id)arg2 waitForReply:(bool)arg3 forceRefresh:(bool)arg4 listenerID:(id)arg5 completionBlock:(id /* block */)arg6;
- (void)_setCurrentIDStatus:(long long)arg1 forDestination:(id)arg2 service:(id)arg3;
- (bool)_sync_currentIDStatusForDestinations:(id)arg1 service:(id)arg2 listenerID:(id)arg3 completionBlock:(id /* block */)arg4;

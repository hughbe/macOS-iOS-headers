...
@property /* Warning: unhandled struct encoding: '{VideoFullscreenInterfaceAVKit=^^?^^?{atomic<unsigned int>={__cxx_atomic_impl<unsigned int' */ struct *fullscreenInterface; /* unknown property attribute:  WTF::DumbPtrTraits<WTF::StringImpl> >=^{StringImpl}}}BBBBBBBBBBBBBBBBBBBBBBB} */

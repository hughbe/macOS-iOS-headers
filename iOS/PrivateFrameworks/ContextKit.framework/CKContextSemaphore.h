...
@interface CKContextSemaphore : NSObject <NSSecureCoding> {
    unsigned int  _sema;
    bool  _semaOwner;
    struct { _Atomic unsigned int x1; _Atomic unsigned int x2; _Atomic unsigned int x3; _Atomic unsigned int x4; _Atomic int x5; _Atomic unsigned int x6; _Atomic unsigned long long x7; _Atomic unsigned int x8; _Atomic unsigned int x9; } * _shm;

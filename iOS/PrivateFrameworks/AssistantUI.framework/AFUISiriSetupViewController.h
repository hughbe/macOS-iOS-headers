...
@interface AFUISiriSetupViewController : UIViewController <UIAdaptivePresentationControllerDelegate, VTUISiriDataSharingOptInPresentationDelegate, VTUITurnOnSiriViewDelegate> {
    UIView * _contentView;

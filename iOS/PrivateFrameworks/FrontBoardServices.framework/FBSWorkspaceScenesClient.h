...
- (void)activate;
- (id)callOutQueue;
- (oneway void)createWithSceneID:(id)arg1 groupID:(id)arg2 parameters:(id)arg3 transitionContext:(id)arg4 completion:(id /* block */)arg5;
- (id)endpoint;
- (id)hostProcess;
- (id)identifier;
- (id)init;
- (id)initWithEndpoint:(id)arg1 queue:(id)arg2 calloutQueue:(id)arg3 workspace:(id)arg4;
- (oneway void)reconnectWithSceneID:(id)arg1 parameters:(id)arg2 transitionContext:(id)arg3 completion:(id /* block */)arg4;

...
- (id)initWithCaptureDeferredPhotoProxy:(id)arg1 expectingPairedVideo:(bool)arg2 adjustmentFilters:(id)arg3 filteredPreviewSurface:(struct __IOSurface { }*)arg4 shouldPersistAdjustmentSidecar:(bool)arg5 persistenceUUID:(id)arg6 coordinationInfo:(id)arg7 error:(id)arg8;
- (id)initWithCapturePhoto:(id)arg1 expectingPairedVideo:(bool)arg2 adjustmentFilters:(id)arg3 filteredPreviewSurface:(struct __IOSurface { }*)arg4 shouldPersistAdjustmentSidecar:(bool)arg5 persistenceUUID:(id)arg6 coordinationInfo:(id)arg7 error:(id)arg8;

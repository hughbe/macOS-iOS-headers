...
@property (nonatomic, readonly) UIColor *lowLightPreviewOverlayColor;
@property (nonatomic, readonly) unsigned long long lowLightPreviewOverlayStyle;
...
- (id)lowLightPreviewOverlayColor;

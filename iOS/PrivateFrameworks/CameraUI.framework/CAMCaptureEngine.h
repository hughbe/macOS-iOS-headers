...
- (id)_powerController;
- (struct { long long x1; long long x2; struct CGSize { double x_3_1_1; double x_3_1_2; } x3; })_previewFilterSetForRequest:(id)arg1 photo:(id)arg2;
- (struct { long long x1; long long x2; struct CGSize { double x_3_1_1; double x_3_1_2; } x3; })_previewFilterSetForRequest:(id)arg1 previewSize:(struct CGSize { double x1; double x2; })arg2;
- (id)_previewFiltersForFilterSet:(struct { long long x1; long long x2; struct CGSize { double x_3_1_1; double x_3_1_2; } x3; })arg1;
...
- (void)_resultsQueue_performPostprocessingForPreviewBuffer:(struct __CVBuffer { }*)arg1 metadata:(id)arg2 filters:(struct { long long x1; long long x2; struct CGSize { double x_3_1_1; double x_3_1_2; } x3; })arg3 stillImageCaptureRequestKey:(id)arg4 completionHandler:(id /* block */)arg5;

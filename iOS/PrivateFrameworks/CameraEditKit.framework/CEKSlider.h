...
@property (nonatomic, retain) UIColor *prominentTickMarkColor;
...
@property (nonatomic, retain) UIColor *tickMarkColor;
...
- (void)setProminentTickMarkColor:(id)arg1;

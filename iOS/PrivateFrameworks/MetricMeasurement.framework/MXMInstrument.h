...
@interface MXMInstrument : NSObject {
    ...
    <MXMInstrumentDelegate> * _delegate;
    bool  _didQuiesce;
...
@property (nonatomic, retain) <MXMInstrumentDelegate> *delegate;
...
- (id)performanceTestConfiguration;
...
- (void)setPerformanceTestConfiguration:(id)arg1;
- (void)start;

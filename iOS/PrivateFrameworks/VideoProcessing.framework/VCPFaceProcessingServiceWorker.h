...
- (id)_suggestionsForPersonLocalIdentifier:(id)arg1 clusterSequenceNumbers:(id)arg2 excludePersonLocalIdentifiers:(id)arg3 cancel:(id /* block */)arg4 context:(id)arg5 error:(id*)arg6;
- (id)_suggestionsForPersonWithLocalIdentifier:(id)arg1 toBeConfirmedPersonSuggestions:(id)arg2 toBeRejectedPersonSuggestions:(id)arg3 cancel:(id /* block */)arg4 error:(id*)arg5;
...
- (void)resetPersonsModelWithContext:(id)arg1 reply:(id /* block */)arg2;
- (void)suggestPersonsForPersonWithLocalIdentifier:(id)arg1 toBeConfirmedPersonSuggestions:(id)arg2 toBeRejectedPersonSuggestions:(id)arg3 context:(id)arg4 reply:(id /* block */)arg5 cancel:(id /* block */)arg6;

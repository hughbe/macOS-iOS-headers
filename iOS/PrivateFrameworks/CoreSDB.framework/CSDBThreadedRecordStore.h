...
- (void)dealloc;
- (id)initWithIdentifier:(struct __CFString { }*)arg1 qosClass:(unsigned short)arg2 lookAsideConfig:(struct CSDBLookAsideBufferConfig { int x1; int x2; unsigned int x3 : 1; })arg3;

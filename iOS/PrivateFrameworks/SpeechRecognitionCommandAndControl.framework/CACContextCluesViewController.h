...
@interface CACContextCluesViewController : UIViewController <CACContextCluesWelcomeControllerDelegate, CACViewController, UIAdaptivePresentationControllerDelegate, UIPresentationControllerDelegatePrivate, _UISheetPresentationControllerDelegate> {
    NSArray * _commands;

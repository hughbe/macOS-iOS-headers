...
- (void)newSpecializedFunctionWithRequestType:(int)arg1 llvmTargetVersion:(unsigned int)arg2 constants:(id)arg3 functionCache:(id)arg4 options:(unsigned int)arg5 sync:(bool)arg6 completionHandler:(id /* block */)arg7;

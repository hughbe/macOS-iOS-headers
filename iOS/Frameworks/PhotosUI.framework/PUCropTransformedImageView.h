...
@property (nonatomic) struct { long long x1; float x2; float x3; } imageModulationOptions;
...
- (struct { long long x1; float x2; float x3; })imageModulationOptions;
...
- (void)setImageModulationOptions:(struct { long long x1; float x2; float x3; })arg1;

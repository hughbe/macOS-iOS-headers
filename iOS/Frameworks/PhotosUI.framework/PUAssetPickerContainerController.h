...
@interface PUAssetPickerContainerController : UIViewController <PUAssetPickerSearchSuggestionsSelectionDelegate, PXChangeObserver, PXPhotosViewDelegate, PXScrollViewControllerObserver, UISearchBarDelegate, UISearchResultsUpdating, _PUPickerUnavailableUIViewControllerDelegate> {
...
@property (nonatomic, readonly) _PUPickerUnavailableUIViewController *unavailableViewController;

...
@interface PUZoomableGridViewController : PUPhotosGridViewController <PUMagnfiedViewControllerDelegate, PXChangeObserver, PXCloudQuotaControllerDelegate, PXPhotosLibraryFooterViewModelPresentationDelegate> {

...
@interface PUPhotosGridViewController : UICollectionViewController <PHAssetCollectionDataSource, PUCollectionViewSelectionDelegate, PUDeletePhotosActionControllerDelegate, PUOneUpPresentationHelperDelegate, PUPhotosGridBarsHelperDelegate, PUScrollViewSpeedometerDelegate, PUSessionInfoObserver, PUSlideshowViewControllerDelegate, PUStackedAlbumControllerTransition, PUSwipeSelectionManagerDataSource, PUSwipeSelectionManagerDelegate, PXActivitySharingControllerDelegate, PXAutoScrollerDelegate, PXCMMActionPerformerDelegate, PXForcedDismissableViewController, PXNavigableAssetContainerViewController, PXPhotosDataSourceChangeObserver, PXPhotosGlobalFooterViewDelegate, PXPhotosGlobalFooterViewLayoutDelegate, PXSettingsKeyObserver, UICollectionViewDragDestination, UICollectionViewDragSource, UIDropInteractionDelegate, UIGestureRecognizerDelegate, UIMultiSelectInteractionDelegate, UIPopoverPresentationControllerDelegate> {

...
- (id).cxx_construct;
- (id)_initWithAttributes:(struct EDIDAttributes { int x1; int x2; int x3; int x4; bool x5; unsigned int x6; unsigned int x7; unsigned int x8; unsigned int x9; unsigned int x10; })arg1;
- (long long)bt2020YCC;

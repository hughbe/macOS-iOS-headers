...
+ (id)searchWithCSQuery:(id)arg1 inStore:(id)arg2 resultHandler:(id /* block */)arg3 completionHandler:(id /* block */)arg4;

- (void).cxx_destruct;
- (void)cancel;
- (id)eventStore;
- (id)initWithSearchWithCSQuery:(id)arg1 inStore:(id)arg2 resultHandler:(id /* block */)arg3 completionHandler:(id /* block */)arg4;
- (id)query;

...
@property (nonatomic, retain) NSArray *_inputModesForTesting;
@property (nonatomic) bool activePreviewEnabled;
@property (nonatomic) bool alwaysAllowInSpringBoard;
...
@property (nonatomic) bool chineseSupportEnabled;
...
@property (nonatomic) bool enableInAllApps;
...
@property (nonatomic, copy) NSString *recognitionLocaleIdentifier;
...
- (void)_performOperations:(id /* block */)arg1 withActiveInputModeIdentifiers:(id)arg2;
- (void)_performOperations:(id /* block */)arg1 withActiveInputModes:(id)arg2;
...
- (void)setRecognitionLocaleIdentifier:(id)arg1;

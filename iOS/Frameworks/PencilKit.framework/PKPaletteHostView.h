...
@interface PKPaletteHostView : UIView <PKPalettePencilInteractionFeedbackHostViewDelegate, PKPaletteTransitionDelegate, PKPaletteViewHosting, PKPaletteViewInternalDelegate, UIGestureRecognizerDelegate, UIPopoverPresentationControllerDelegate> {

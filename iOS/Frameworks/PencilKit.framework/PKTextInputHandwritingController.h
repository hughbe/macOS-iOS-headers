...
@interface PKTextInputHandwritingController : NSObject <PKTextInputCanvasControllerChangeObserver, PKTextInputDebugStateReporting, PKTextInputHandwritingShotDelegate, PKTextInputResultCommandDelegate> {

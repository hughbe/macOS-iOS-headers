...
- (id)initWithRequest:(id)arg1 presenter:(struct PaymentAuthorizationPresenter { int (**x1)(); struct WeakPtrFactory<WebKit::PaymentAuthorizationPresenter, WTF::EmptyCounter> { struct RefPtr<WTF::WeakPtrImpl<WTF::EmptyCounter>, WTF::DumbPtrTraits<WTF::WeakPtrImpl<WTF::EmptyCounter> > > { struct WeakPtrImpl<WTF::EmptyCounter> {} *x_1_2_1; } x_2_1_1; } x2; struct Client {} *x3; }*)arg2;

...
- (struct RectEdges<bool> { struct array<bool, 4> { bool x_1_1_1[4]; } x1; })rubberbandableDirections;
...
- (struct RectEdges<bool> { struct array<bool, 4> { bool x_1_1_1[4]; } x1; })scrollableDirectionsFromOffset:(struct CGPoint { double x1; double x2; })arg1;

...
@interface INIntentDeliverer : NSObject <INIntentParameterOptionsProviding> {
    <INIntentDelivererDataSource> * _dataSource;
    <INIntentDelivererDelegate> * _delegate;
...
@property (nonatomic) <INIntentDelivererDataSource> *dataSource;
@property (readonly, copy) NSString *debugDescription;
@property (nonatomic) <INIntentDelivererDelegate> *delegate;

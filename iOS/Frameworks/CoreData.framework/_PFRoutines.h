...
+ (void)efficientlyEnumerateManagedObjectsInFetchRequest:(id)arg1 usingManagedObjectContext:(id)arg2 andApplyBlock:(id /* block */)arg3;
...
+ (void)wrapBlockInGuardedAutoreleasePool:(id /* block */)arg1;

...
- (double)endTime;
- (long long)gpsSource;
- (id)initWithCLStrideCalEntry:(struct { int x1; double x2; unsigned int x3; double x4; double x5; double x6; double x7; double x8; int x9; int x10; double x11; double x12; int x13; double x14; })arg1;

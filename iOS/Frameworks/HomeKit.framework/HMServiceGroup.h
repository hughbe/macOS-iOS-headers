...
@interface HMServiceGroup : NSObject <HFFavoritable, HFHomeKitObject, HFHomeStatusVisible, HFReorderableHomeKitObject, HFServiceNameComponentsProviding, HFStateDumpBuildable, HFUserNotificationServiceSettingsProviding, HMFLogging, HMFMessageReceiver, HMMutableApplicationData, HMObjectMerge, NSSecureCoding> {

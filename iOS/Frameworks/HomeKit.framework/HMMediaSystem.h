...
@interface HMMediaSystem : NSObject <HFHomeKitObject, HFMediaProfileContainer, HFServiceNameComponentsProviding, HMAccessorySettingsContainer, HMApplicationData, HMControllable, HMFLogging, HMFMessageReceiver, HMMediaObject, HMObjectMerge, NSSecureCoding> {

...
@interface HMService : NSObject <HFFavoritable, HFHomeContainedObject, HFHomeStatusVisible, HFReorderableHomeKitObject, HFRoomContextProviding, HFServiceNameComponentsProviding, HFStateDumpBuildable, HFUserNotificationServiceSettingsProviding, HMFLogging, HMMutableApplicationData, HMObjectMerge, NSSecureCoding> {

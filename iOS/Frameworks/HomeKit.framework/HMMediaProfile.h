...
@interface HMMediaProfile : HMAccessoryProfile <HFMediaProfileContainer, HFServiceNameComponentsProviding, HMAccessorySettingsContainer, HMMediaObject, _HMMediaProfileDelegate> {

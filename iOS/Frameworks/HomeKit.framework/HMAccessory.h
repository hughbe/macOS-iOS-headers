...
@interface HMAccessory : NSObject <HFFavoritable, HFHomeContainedObject, HFReorderableHomeKitObject, HFRoomContextProviding, HFServiceNameComponentsProviding, HFStateDumpBuildable, HFSymptomFixableObject, HMAccessorySettingsContainer, HMApplicationData, HMControllable, HMFLogging, HMFMessageReceiver, HMFObject, HMMutableApplicationData, HMObjectMerge, NSSecureCoding> {
...
@property (nonatomic) unsigned long long supportedStereoPairVersions;

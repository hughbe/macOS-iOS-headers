...
@property (nonatomic, retain) NSObject<OS_dispatch_queue> *appendQueue;
...
@property (nonatomic, retain) CKStreamingAsset *streamingAsset;
...
- (void)setStreamingAsset:(id)arg1;
- (id)streamingAsset;

...
@interface SNSpeechUtteranceResult : NSObject <NSCopying, NSSecureCoding, SNConfidenceProviding, SNConfidenceProvidingWritable, SNTimeRangeProviding, SNTimeRangeProvidingWritable> {
    double  _confidence;
    bool  _detected;
    struct { 
        struct { 

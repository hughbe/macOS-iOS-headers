...
@interface SNAudioOffsetResult : NSObject <NSCopying, NSSecureCoding, SNConfidenceProviding, SNConfidenceProvidingWritable, SNTimeRangeProviding, SNTimeRangeProvidingWritable> {
    double  _confidence;
    double  _offset;
    struct { 
        struct { 

...
- (void)invalidate;
- (void)movingItemAtLocation:(id)arg1 requiresProvidingWithDestinationLocation:(id)arg2 completionHandler:(id /* block */)arg3;
...
- (id /* block */)provideItemForKernelRequestWithOperation:(unsigned int)arg1 atURL:(id)arg2 forProcess:(int)arg3 withOptions:(unsigned long long)arg4 completionHandler:(id /* block */)arg5;

...
- (void)generateClipWithSeconds:(double)arg1 handler:(id /* block */)arg2;
...
- (void)startClipBufferingWithMicrophoneEnabled:(bool)arg1 withHandler:(id /* block */)arg2;
...
- (void)stopClipBufferingWithHandler:(id /* block */)arg1;

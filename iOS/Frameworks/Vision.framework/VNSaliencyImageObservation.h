...
- (id)initWithRequestRevision:(unsigned long long)arg1 rawSaliencyImage:(struct __CVBuffer { }*)arg2 originalImageSize:(struct CGSize { double x1; double x2; })arg3 salientObjectBoundingBoxes:(id)arg4;

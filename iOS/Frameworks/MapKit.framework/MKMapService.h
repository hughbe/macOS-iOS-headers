...
- (id)ticketForSpatialPlaceLookupWithCenterCoordinate:(struct CLLocationCoordinate2D { double x1; double x2; })arg1 radius:(double)arg2 pointOfInterestFilter:(id)arg3;

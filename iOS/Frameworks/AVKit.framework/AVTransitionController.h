...
@interface AVTransitionController : NSObject <AVTransitionDelegate, AVTransitionDriverDelegate, UIViewControllerAnimatedTransitioning, UIViewControllerInteractiveTransitioning, UIViewControllerTransitioningDelegate> {

...
@interface LPMapCollectionMetadata : LPSpecializationMetadata <LPLinkMetadataBackwardCompatibility, LPLinkMetadataPresentationTransformer, LPLinkMetadataPreviewTransformer> {
    NSArray * _addresses;
    LPImage * _darkImage;
    LPImage * _icon;
    LPImage * _image;

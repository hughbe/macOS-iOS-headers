...
- (void).cxx_destruct;
- (struct CGSize { double x1; double x2; })_availableSizeForImageNumber:(unsigned long long)arg1 withLayout:(unsigned long long)arg2 withinSize:(struct CGSize { double x1; double x2; })arg3;

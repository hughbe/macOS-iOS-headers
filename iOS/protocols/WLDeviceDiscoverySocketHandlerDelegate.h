...
- (void)deviceDiscoverySocketHandler:(WLDeviceDiscoverySocketHandler *)arg1 didFinishHandshakeWithSourceDevice:(WLSourceDevice *)arg2 priorConnectionFailureReasons:(NSArray *)arg3;

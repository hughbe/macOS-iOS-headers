...
- (void)remoteCommandServer:(JFXRemoteCommandServer *)arg1 didReceiveAddStickerCommandWithURL:(NSURL *)arg2 offset:(struct CGPoint { double x1; double x2; })arg3 scale:(double)arg4 rotation:(double)arg5;

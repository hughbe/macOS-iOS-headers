...
- (void)launchOutOfProcessAuthentication:(void *)arg1 surrogateID:(void *)arg2 withErrorHandler:(void *)arg3; // needs 3 arg types, found 8: AKAppleIDAuthenticationContext *, NSUUID *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
...
- (void)presentBiometricOrPasscodeValidationForContext:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 8: AKAppleIDAuthenticationContext *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, unsigned long long, NSError *, void*

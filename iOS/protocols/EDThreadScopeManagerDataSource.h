...
- (void)threadScopeManager:(void *)arg1 populateThreadScopesWithBlock:(void *)arg2; // needs 2 arg types, found 12: EDThreadScopeManager *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, long long, NSString *, NSNumber *, NSData *, bool, NSDate *, void*

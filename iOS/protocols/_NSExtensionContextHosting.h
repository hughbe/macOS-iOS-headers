...
- (void)_loadItemForPayload:(void *)arg1 contextIdentifier:(void *)arg2 completionHandler:(void *)arg3; // needs 3 arg types, found 9: NSDictionary *, NSUUID *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, id, NSError *, void*
- (void)_loadPreviewImageForPayload:(void *)arg1 contextIdentifier:(void *)arg2 completionHandler:(void *)arg3; // needs 3 arg types, found 9: NSDictionary *, NSUUID *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, id, NSError *, void*

...
- (void)_renderLiveSelectionPath:(const struct CGPath { }*)arg1 forStrokes:(NSOrderedSet *)arg2 inDrawing:(PKDrawing *)arg3 liveScrollOffset:(struct CGPoint { double x1; double x2; })arg4;

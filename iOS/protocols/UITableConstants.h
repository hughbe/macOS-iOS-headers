...
- (struct UIEdgeInsets { double x1; double x2; double x3; double x4; })defaultLayoutMarginsForScreen:(UIScreen *)arg1 size:(struct CGSize { double x1; double x2; })arg2;
...
- (struct CGSize { double x1; double x2; })defaultReorderControlSizeForCell:(UIView<UITableConstantsCellProviding> *)arg1 inTableView:(id <UITableConstantsTableProviding>)arg2;
...
- (<UITableConstants> *)variantForActive:(bool)arg1 dark:(bool)arg2 focused:(bool)arg3;

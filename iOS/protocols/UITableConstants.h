...
- (struct _UITableConstantsBackgroundProperties { bool x1; id x2; id x3; bool x4; long long x5; })defaultCellBackgroundPropertiesForTableViewStyle:(long long)arg1 state:(id <_UICellConfigurationStateReadonly>)arg2;

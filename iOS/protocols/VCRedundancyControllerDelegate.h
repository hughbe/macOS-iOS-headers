...
- (void)redundancyController:(id <VCRedundancyControllerProtocol>)arg1 redundancyVectorDidChange:(struct { unsigned short x1; struct { unsigned char x_2_1_1; unsigned char x_2_1_2; } x2[16]; })arg2;

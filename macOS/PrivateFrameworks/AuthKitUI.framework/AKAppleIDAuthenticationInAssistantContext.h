...
@class AKAuthWebTabView, AKInAssistantSecondFactorCodeEntry, AKiCDPDeviceValidationFlowViewController, CDPRemoteDeviceSecretValidator, NSArray, NSMutableArray, NSMutableDictionary, NSObject<AKAppleIDAuthenticationAssistant>, NSProgressIndicator, NSSecureTextField, NSString, NSTextField;

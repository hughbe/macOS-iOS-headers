...
@class NSButton, NSImage, NSImageCell, NSLayoutConstraint, NSProgressIndicator, NSString, NSTextField, NSView;

@interface AKSignInPromptController : NSViewController
{

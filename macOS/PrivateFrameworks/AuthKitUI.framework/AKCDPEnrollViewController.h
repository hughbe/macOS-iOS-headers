...
@class AKPinFieldView, CDPContext, CDPDevice, CDPRemoteDeviceSecretValidator, IASPickerViewController, NSArray, NSButton, NSLayoutConstraint, NSMutableArray, NSNumber, NSProgressIndicator, NSSecureTextField, NSString, NSTextField, NSView, NSWindow;

@interface AKCDPEnrollViewController : NSViewController <AKPinFieldViewDelegate>
{
...
- (void)handlePasswordIsLocalPassword:(id)arg1 andCDPDevice:(id)arg2;

...
@property(retain, nonatomic) NSMutableArray *recordsNeedingUpdatedSharingInfo; // @synthesize recordsNeedingUpdatedSharingInfo=_recordsNeedingUpdatedSharingInfo;
@property(retain, nonatomic) NSMutableArray *recordsNeedingNewSharingInfo; // @synthesize recordsNeedingNewSharingInfo=_recordsNeedingNewSharingInfo;
...
- (void).cxx_destruct;
- (void)main;
- (void)_performUpdateSharingInfoIfNecessary:(CDUnknownBlockType)arg1;
- (void)_scheduleUnsharingAndModifyRecordsAndZoneCreationOperation;
- (void)_performUnsharingAndModifyRecordsWithCompletion:(CDUnknownBlockType)arg1;

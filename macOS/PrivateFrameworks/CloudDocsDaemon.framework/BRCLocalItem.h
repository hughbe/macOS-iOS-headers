...
@class BRCAccountSession, BRCAliasItem, BRCAppLibrary, BRCClientZone, BRCDirectoryItem, BRCDocumentItem, BRCFSRootItem, BRCFinderBookmarkItem, BRCItemID, BRCLocalStatInfo, BRCServerZone, BRCSharedDocumentItem, BRCSymlinkItem, CKRecord, CKRecordID, NSError, NSMutableSet, NSNumber, NSString;

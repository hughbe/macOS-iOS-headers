...
@class BRCAccountSession, BRCFSEventsPersistedState, BRCRelativePath, BRCVolume, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_semaphore>, NSObject<OS_dispatch_source>, NSString, PQLConnection;

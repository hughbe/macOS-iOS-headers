...
- (BOOL)createSharedAppLibraryOnDiskWithMangledID:(id)arg1 createdRoot:(char *)arg2;
- (BOOL)createAppLibraryOnDisk:(id)arg1 createdRoot:(char *)arg2 createdDocuments:(char *)arg3;
...
- (void)destroyAppLibrary:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)destroyAppLibrary:(id)arg1;
...
- (id)_getOrCreateAppLibraryAndZonesIfNecessary:(id)arg1 ownerName:(id)arg2 alreadyExistsAndResumed:(char *)arg3;
- (void)__registerServerZone:(id)arg1 clientZone:(id)arg2 appLibrary:(id)arg3 isShared:(BOOL)arg4;
- (id)__getOrCreateAppLibrary:(id)arg1 ownerName:(id)arg2 rowID:(id)arg3 createOnDisk:(BOOL)arg4 alreadyExistsAndResumed:(char *)arg5 zoneID:(id)arg6 withClientZone:(id)arg7;
...
- (BOOL)_recursivelyPrepareFolderForLogOutAtURL:(id)arg1 pruneEmptyFolders:(BOOL)arg2 maxDepth:(unsigned long long)arg3;
...
- (void)setUserIdentity:(id)arg1 forName:(id)arg2;

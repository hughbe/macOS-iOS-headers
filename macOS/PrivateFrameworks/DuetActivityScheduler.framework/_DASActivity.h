...
@class CDAttribute, NSArray, NSDate, NSDictionary, NSObject<OS_dispatch_queue>, NSString, _DASFileProtection;
...
@interface _DASActivity : NSObject <NSCopying, NSSecureCoding>
{
    ...
    BOOL _beforeFirstActivityOfDay;
...
@property(nonatomic) BOOL beforeFirstActivityOfDay; // @synthesize beforeFirstActivityOfDay=_beforeFirstActivityOfDay;

...
@class AUAudioUnitBusArray, AUAudioUnitPreset, AUParameterTree, NSArray, NSDictionary, NSExtension, NSMutableArray, NSString, NSURL, NSUUID, NSViewController, NSXPCConnection;

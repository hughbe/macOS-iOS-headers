...
@class NSDate, NSManagedObjectContext, NSObject<OS_dispatch_queue>, NSPersistentStore, NSPersistentStoreCoordinator, NSString, NSURL;
...
@property(nonatomic, getter=isSuspendedForAccountChange) BOOL suspendedForAccountChange; // @synthesize suspendedForAccountChange=_suspendedForAccountChange;
...
- (BOOL)save;
- (id)insertEntryWithValue:(id)arg1;
...
- (void)runLegacyMigrationAndMaintenance;
- (void)cleanup;
- (id)init;

...
@class NSDictionary, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, NSURL, SCRBrailleLineManager, SCRCTargetSelectorTimer, SCRCThreadKey, SCRElement<SCRApplicationDirectChildProtocol>, SCREvent, SCRMenu, SCROutputSharedFocusManager, SCRUIElement;
...
- (void)_createRemoteGuideItemsForRemoteGuide:(id)arg1 guideInfo:(id)arg2;
...
- (void)dispatchCreateRemoteGuideItemsForRemoteGuide:(id)arg1 guideInfo:(id)arg2;

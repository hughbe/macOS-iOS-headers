...
- (BOOL)setInclusionVerifiedStateForLogEntry:(id)arg1 error:(id *)arg2;
- (BOOL)setInclusionVerifiedStateForTopLevelTreeNode:(id)arg1 error:(id *)arg2;
- (BOOL)setInclusionVerifiedStateForPerApplicationTreeNode:(id)arg1 error:(id *)arg2;

...
@class NSData, NSString, PKPaymentMethod, PKServiceProviderPurchase;
...
@property(retain, nonatomic) PKServiceProviderPurchase *serviceProviderPurchase; // @synthesize serviceProviderPurchase=_serviceProviderPurchase;

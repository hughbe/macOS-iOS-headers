...
@class NSArray, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, PABinaryLocator, PAGenealogyTracker, PAMountStatusTracker, PASampleTimeInsensitiveTaskData, PASymbolDataStore, PAWSUpdateDataStore;
...
- (BOOL)addKCDataThread:(const struct thread_snapshot_v2 *)arg1 orDeltaThread:(const struct thread_delta_snapshot_v2 *)arg2 withStack:(id)arg3 andName:(const char *)arg4 toTask:(id)arg5 withCurrentThreads:(id)arg6 withPreviousThreads:(id)arg7;

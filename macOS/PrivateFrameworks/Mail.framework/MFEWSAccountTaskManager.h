...
{
    NSMutableSet *_synchronizedMailboxURLStrings;
...
- (void)accountSyncActivityFinishedFolderHierarchyReconcile:(id)arg1;
- (void)accountSyncActivity:(id)arg1 failedToSyncMailboxURL:(id)arg2;
...
- (id)_unsynchronizedMailboxURLStrings;

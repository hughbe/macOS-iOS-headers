...
+ (void)setLastSpotlightCheckDate:(id)arg1 forMessages:(id)arg2;
...
+ (void)triggerFullSpotlightImportOfDirectory:(id)arg1;
...
+ (long long)rowidForMailboxURL:(id)arg1 db:(struct sqlite3 *)arg2 cache:(id)arg3;

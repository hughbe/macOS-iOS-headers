...
+ (Class)stringMapper;
+ (void)initialize;
+ (id)versionsInFaceCollection:(id)arg1;
...
+ (void)deleteFromAnalysisStateForVersionIds:(id)arg1 fromDatabase:(id)arg2 withReason:(unsigned short)arg3;
+ (id)uuidsForAnalysisWithWorkerType:(short)arg1 additionalStatesToExclude:(id)arg2 fetchLimit:(unsigned long long)arg3 database:(id)arg4 error:(id *)arg5;
...
- (void)_invalidateAndReloadForGraphWorker;
- (void)_invalidateForGraphWorker;
...
- (void)obtainReadAccessToFaceTile:(unsigned long long)arg1 toURLWithHandler:(CDUnknownBlockType)arg2;

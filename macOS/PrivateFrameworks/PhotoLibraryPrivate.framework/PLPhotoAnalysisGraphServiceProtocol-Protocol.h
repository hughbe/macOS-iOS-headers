...
- (void)requestSetShowHolidayCalendarEvents:(BOOL)arg1 context:(NSDictionary *)arg2 reply:(void (^)(NSError *))arg3;
- (void)requestIsShowingHolidayCalendarEventsWithContext:(NSDictionary *)arg1 reply:(void (^)(BOOL, NSError *))arg2;

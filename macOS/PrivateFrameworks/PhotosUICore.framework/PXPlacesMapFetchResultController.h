...
@class NSObject<OS_dispatch_queue>, PXPlacesMapController, PXPlacesMapPipeline, PXPlacesMapView, PXPlacesMapViewController, PXPlacesPhotoAssetsStore;
...
- (id)initWithGeotaggableInfoDelegate:(id)arg1;

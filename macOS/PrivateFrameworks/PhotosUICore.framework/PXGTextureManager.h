...
- (void)_blockOnThumbnailsIfNeededWithGeometries:(CDStruct_3ab912e1 *)arg1 visibleRect:(struct CGRect)arg2 interactionState:(CDStruct_efb11229)arg3 fences:(id)arg4;

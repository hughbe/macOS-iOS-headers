...
@class NSMutableSet, NSObject<OS_dispatch_semaphore>, NSSet, NSString;
...
@property NSMutableSet *itemsToRemove; // @synthesize itemsToRemove=_itemsToRemove;
@property NSMutableSet *itemsToAdd; // @synthesize itemsToAdd=_itemsToAdd;

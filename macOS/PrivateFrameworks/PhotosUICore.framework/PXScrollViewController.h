...
@class NSHashTable, NSObject<PXAnonymousScrollView>, NSString, PXTilingScrollInfo;
...
@property(readonly, nonatomic) id contentCoordinateSpace; // @synthesize contentCoordinateSpace=_contentCoordinateSpace;

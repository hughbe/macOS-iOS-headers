...
@property(nonatomic) double addToTabPopScale; // @synthesize addToTabPopScale=_addToTabPopScale;
@property(nonatomic) double addToTabPopDuration; // @synthesize addToTabPopDuration=_addToTabPopDuration;

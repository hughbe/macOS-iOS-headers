...
@class NSArray, NSObject<OS_nw_path>, NSObject<OS_xpc_object>, NSString, NSUUID, NWEndpoint, NWInterface, NWParameters;
...
@property(retain, nonatomic) NSObject<OS_xpc_object> *proxySettings;

...
@class NSError, NSObject<OS_nw_connection>, NWEndpoint, NWParameters, NWPath;
...
@property(retain, nonatomic) NSObject<OS_nw_connection> *internalConnection; // @synthesize internalConnection=_internalConnection;

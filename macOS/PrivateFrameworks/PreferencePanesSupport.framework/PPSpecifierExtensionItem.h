...
#import <PreferencePanesSupport/PPSpecifierExtensionPosting-Protocol.h>

@class NSArray, NSExtension, NSImage, NSRemoteViewController, NSString, NSView, NSXPCConnection, NSXPCListener;

...
@class IASUnifiedProgressClient, NSArray, NSDate, NSError, NSMutableArray, NSNumber, NSObject<OSInstallControllerDelegate>, NSObject<OS_dispatch_queue>, NSString, NSTimer, OSIDebuggerTool, OSIPowerController, OSInstallOptions;

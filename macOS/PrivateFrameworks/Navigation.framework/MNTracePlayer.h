...
#import "MNTracePlayerTimelineStreamDelegate.h"

@class GEOETAUpdater, MNTrace, MNTracePlayerETAUpdater, MNTracePlayerScheduler, MNTracePlayerTimelineStream, NSData, NSDate, NSHashTable, NSString;

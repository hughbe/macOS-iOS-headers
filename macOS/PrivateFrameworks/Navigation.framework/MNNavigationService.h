...
@class GEOComposedRoute, GEOComposedWaypoint, GEODirectionsRequest, GEODirectionsResponse, MNLocation, MNNavigationDetails, MNObserverHashTable, MNSettings, NSArray, NSMutableDictionary, NSString;

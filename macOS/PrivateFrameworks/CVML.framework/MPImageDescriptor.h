...
- (void)computeQualityForImageData:(id)arg1 andQualityCriteria:(id)arg2 context:(id)arg3 error:(id *)arg4;
- (void)computeRegistrationFeaturesForImageData:(id)arg1 context:(id)arg2 error:(id *)arg3;
- (void)computeDescriptorForImageData:(id)arg1 context:(id)arg2 error:(id *)arg3;
- (void)computeConvnetDescriptorForImageData:(id)arg1 context:(id)arg2 error:(id *)arg3;
- (void)dealloc;

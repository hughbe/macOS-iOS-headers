...
@class NSString, PKPaymentAuthorizationDataModel, PKPaymentAuthorizationLayout, PKPaymentRemoteDevicePreferenceController, PKPaymentShippingAddressPreferenceController, PKPaymentShippingContactPreferenceController, PKPaymentShippingMethodPreferenceController;

...
@interface iCloudSetupTopLevelViews : NSObject
{
    ...
    NSView *_verificationMailSent;
    NSButton *_serivesEnableButton;
    NSButton *_FMMEnableButton;
    NSButton *_openMailButton;
    NSTextField *_verificationSentText;
    NSTextField *_verificationSentDescription;
...
@property(retain) NSTextField *verificationSentDescription; // @synthesize verificationSentDescription=_verificationSentDescription;
@property(retain) NSTextField *verificationSentText; // @synthesize verificationSentText=_verificationSentText;
@property(retain) NSButton *openMailButton; // @synthesize openMailButton=_openMailButton;
...
@property(retain) NSView *verificationMailSent; // @synthesize verificationMailSent=_verificationMailSent;

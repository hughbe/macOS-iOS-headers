...
@class CastlePlugin, MMInfoCapacityBarView, MMWebKitViewController, MM_Account, NSButton, NSDictionary, NSMutableDictionary, NSString, NSTableView, NSTextField;
...
@interface IACastleServicesView : NSView <MMWebKitViewControllerDelegate, iCloudWebViewDelegate>
{
    ...
    NSTextField *_unverfiedAccountTitle;
    NSTextField *_unverfiedAccountDescription;
    NSButton *_unverfiedAccountResendEmailButton;

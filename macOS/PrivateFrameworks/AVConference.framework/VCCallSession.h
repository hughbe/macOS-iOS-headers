...
@class GKRingBuffer, NSArray, NSData, NSDictionary, NSMutableArray, NSMutableDictionary, NSNumber, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSObject<VCCallSessionDelegate>, NSObject<VideoConferenceChannelQualityDelegate>, NSObject<VideoConferenceRealTimeChannel>, NSString, TimingCollection, VCAudioPayload, VCAudioTier, VCAudioTierPicker, VCAudioTransmitter, VCBitrateArbiter, VCCallInfo, VCCallLinkCongestionDetector, VCCapabilities, VCCaptionsReceiver, VCConnectionManager, VCImageAttributeRules, VCMediaNegotiator, VCPacketBundler, VCSecureDataChannel, VCSessionMessaging, VCWCMClient, VideoAttributes, WRMClient;
...
@interface VCCallSession : NSObject <VCSecureDataChannelDelegate, VCCaptionsReceiverDelegate, VCTransportSessionLegacyDelegate>
{
    ...
    id <VCTransportSessionProtocol> _transportSession;
    BOOL _cleanupDone;
}
...
- (void)handleDuplication:(BOOL)arg1 withPreferredLocalLinkTypeForDuplication:(int)arg2;
...
- (BOOL)createSDP:(int *)arg1 audioPayloadCount:(int)arg2 secondaryPayloadTypes:(int *)arg3 secondaryPayloadCount:(int)arg4 videoPayloadTypes:(int *)arg5 videoPayloadCount:(int)arg6 screenPayloadTypes:(int *)arg7 screenPayloadCount:(int)arg8 localFeaturesList:(id)arg9 answerBandwidth:(int)arg10 maxBandwidth:(int)arg11 imageSizesSend:(struct imageTag **)arg12 imageSendCount:(int *)arg13 imageSizesRecv:(struct imageTag **)arg14 imageRecvCount:(int *)arg15 screenSizesSend:(struct imageTag **)arg16 screenSendCount:(int *)arg17 screenSizesRecv:(struct imageTag **)arg18 screenRecvCount:(int *)arg19 sdp:(char *)arg20 numSDPBytes:(int *)arg21 error:(id *)arg22;
...
- (int)flushBasebandQueueWithPayloads:(id)arg1;

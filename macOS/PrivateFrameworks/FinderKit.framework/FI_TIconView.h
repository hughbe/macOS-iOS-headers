...
@interface FI_TIconView : FI_TImageBrowserView <TShrinkToFitDelegateProtocol, TDragImageProtocol, NSUserInterfaceItemIdentification, NSScrollViewDelegate>
{
    ...
    id <TBrowserViewDelegate><TSpringLoadingDestinationDelegate> _iconViewDelegate;
    ...
    struct unordered_map<TFENode, TNSRef<FI_TInlineProgressHostLayer *, void>, std::__1::hash<TFENode>, std::__1::equal_to<TFENode>, std::__1::allocator<std::__1::pair<const TFENode, TNSRef<FI_TInlineProgressHostLayer *, void>>>> _nodeToInlineProgressLayerMap;
    struct TFENode _alwaysVisibleNode;
    struct TFENode _mouseDownNode;
    struct CGPoint _lastMouseDraggedLocation;
    struct TNSRef<NSDate *, void> _dateOfLastMouseDraggedEvent;
    struct TNSRef<NSArray *, void> _cachedAXChildren;
}
...
@property(nonatomic) id <TBrowserViewDelegate><TSpringLoadingDestinationDelegate> iconViewDelegate; // @synthesize iconViewDelegate=_iconViewDelegate;
...
- (void)invalidateAXChildrenCache;

...
@class FI_TListHeaderRowView, FI_TListNameField, FI_TListTableColumn, NSDictionary, NSString;
...
@interface FI_TListViewController : FI_TBrowserViewController <NSOutlineViewDelegate, NSTableViewDelegate, NSOutlineViewDataSource, NSWindowDelegate, NSScrollViewDelegate>
{
    ...
    _Bool _editing;
    struct TNSRef<FI_TListNameField *, void> _originalEditedNameField;
...
- (_Bool)nameColumnUsesCustomColorAppearanceForNode:(const struct TFENode *)arg1;
...
- (id)newNameForCellOrNil:(id)arg1;
- (id)longerOrShorterNameOrNil:(id)arg1 withNonTextWidth:(double)arg2;
- (_Bool)preferShorterAttribute:(id)arg1;
- (id)outlineView:(id)arg1 viewForTableColumn:(id)arg2 item:(id)arg3;
- (id)customNameColumnValue:(id)arg1 secondaryTextColor:(id)arg2 forNode:(const struct TFENode *)arg3 preferShorter:(_Bool)arg4;
...
- (void)updateICloudStatusCellView:(id)arg1 node:(const struct TFENode *)arg2 progressStatus:(struct TNodeProgressStatus)arg3;
- (void)updateBadgeAndProgressForNameCellView:(id)arg1 node:(const struct TFENode *)arg2 progressStatus:(struct TNodeProgressStatus)arg3;
- (void)updateBadgeAndProgressForRowView:(id)arg1 node:(const struct TFENode *)arg2;
...
@property(retain, nonatomic) FI_TListNameField *originalEditedNameField; // @dynamic originalEditedNameField;

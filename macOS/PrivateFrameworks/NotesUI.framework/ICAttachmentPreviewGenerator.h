...
{
    _Atomic char _shouldGenerateAttachmentsWhenReachable;
...
+ (id)sharedGenerator;
- (void).cxx_destruct;
@property(nonatomic) _Atomic char shouldGenerateAttachmentsWhenReachable; // @synthesize shouldGenerateAttachmentsWhenReachable=_shouldGenerateAttachmentsWhenReachable;

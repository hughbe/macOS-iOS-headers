...
- (id)_generateNotificationRequestForMessageRecord:(struct _IMDMessageRecordStruct *)arg1 isUrgentMessage:(BOOL)arg2 isCarouselUITriggered:(BOOL)arg3 isMostActive:(BOOL)arg4 shouldAdvanceLastAlertedMessageDate:(char *)arg5;

...
@class NSDate, NSDictionary, NSError, NSMutableDictionary, NSSet, NSString, NSURL, NSUUID, UAPeerDevice;
...
@property(retain) UAPeerDevice *peerDevice; // @synthesize peerDevice=_peerDevice;

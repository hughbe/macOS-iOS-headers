...
@class CKContainer, ICSelectorDelayer, NSDate, NSDictionary, NSMutableSet, NSObject<OS_dispatch_queue>, NSOperationQueue, NSTimer;
...
- (void)handleGenericPartialFailuresForError:(id)arg1 databaseScope:(long long)arg2;
...
- (id)operationsToModifyRecordsForCloudObjectsToSave:(id)arg1 delete:(id)arg2 deleteShares:(id)arg3 addDependencies:(BOOL)arg4;

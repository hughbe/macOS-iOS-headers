...
@class ICAccountUtilities, ICNote, ICNotesCrossProcessChangeCoordinator, ICSelectorDelayer, NSManagedObjectContext, NSMutableSet, NSNumber, NSObject<OS_dispatch_queue>, NSPersistentStoreCoordinator, NSString, NSTimer;
...
+ (BOOL)isActive;
+ (void)crashThisApp;
+ (id)cloudSyncingObjectsMatchingPredicate:(id)arg1 managedObjectContext:(id)arg2;

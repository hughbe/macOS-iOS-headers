...
- (void)authenticateUsingAlternateMethodForDeletingNotes:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)authenticatePasswordForDeletingNotes:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;

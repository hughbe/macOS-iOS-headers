...
@interface VCPAudioAnalyzer : NSObject
{
    ...
    CDStruct_1b6d18a9 _detectionStart;
...
+ (id)voiceDetector;
- (void).cxx_destruct;
- (int)analyzeAsset:(id)arg1 cancel:(CDUnknownBlockType)arg2 result:(id *)arg3;
- (int)processSampleBuffer:(struct opaqueCMSampleBuffer *)arg1;
- (int)processAudioSamples;
- (void)addDetectionFromTime:(const CDStruct_1b6d18a9 *)arg1 toTime:(const CDStruct_1b6d18a9 *)arg2;

...
@class ABLEBSMPluginMonitor, ABLEBSMRoutineMonitor, ABLECoreData, CDSession, NSArray, NSDate, NSDictionary, NSLocale, NSMutableArray, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSUserDefaults;

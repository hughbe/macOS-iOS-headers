...
@class CKEntity, NSArray, NSString;

@interface CKStreamObserver : NSObject
{
    BOOL _invalidated;
    ...
    NSArray *_filters;
    CKEntity *_anchorEntity;
}

@property(nonatomic) BOOL anchorEntityDidSelect; // @synthesize anchorEntityDidSelect=_anchorEntityDidSelect;
@property(retain, nonatomic) CKEntity *anchorEntity; // @synthesize anchorEntity=_anchorEntity;

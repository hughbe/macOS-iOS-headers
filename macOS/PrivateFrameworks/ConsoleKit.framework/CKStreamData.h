...
@class CKEntity, CKStreamSortedData, NSObject<OS_os_log>;

@interface CKStreamData : NSObject
{
    NSObject<OS_os_log> *_log;
    id <CKStreamDataDelegate> _delegate;
    unsigned long long _capacity;
    unsigned long long _direction;
    CKEntity *_keyEntity;
    CKStreamSortedData *_sortedData;
    unsigned long long _objectsCount;
}

@property(nonatomic) unsigned long long objectsCount; // @synthesize objectsCount=_objectsCount;
@property(readonly, nonatomic) CKStreamSortedData *sortedData; // @synthesize sortedData=_sortedData;
...
@property(nonatomic) __weak id <CKStreamDataDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (id)debugDescription;

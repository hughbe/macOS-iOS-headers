...
#import "CKStreamDelegate.h"
#import "CSKTableViewControllerDelegate.h"

@class CKStream, CKStreamSource, CKUIActivityDetailsViewController, CKUIMessageDetailsViewController, CKUIStatusViewController, CKUIStreamActivitiesObserver, CKUIStreamMessagesObserver, CKUITableColumnLayout, CSKActivitiesViewController, CSKMessagesViewController, CSKTableViewController, NSFont, NSSplitViewController, NSString;

@interface CKUIStreamViewController : NSViewController <CKStreamDelegate, CSKTableViewControllerDelegate>
{
    ...
    id <CKUIStreamViewControllerDelegate> _delegate;
    ...
    CKUIMessageDetailsViewController *_messageDetailsViewController;
    CKUIStreamActivitiesObserver *_activitiesObserver;
    CSKActivitiesViewController *_activitiesViewController;
    CKUIActivityDetailsViewController *_activityDetailsViewController;
    CKUIStatusViewController *_statusViewController;
...
@property(readonly, nonatomic) CKUIStatusViewController *statusViewController; // @synthesize statusViewController=_statusViewController;
@property(readonly, nonatomic) CKUIActivityDetailsViewController *activityDetailsViewController; // @synthesize activityDetailsViewController=_activityDetailsViewController;
...
@property(readonly, nonatomic) CKUIStreamActivitiesObserver *activitiesObserver; // @synthesize activitiesObserver=_activitiesObserver;
@property(readonly, nonatomic) CKUIMessageDetailsViewController *messageDetailsViewController; // @synthesize messageDetailsViewController=_messageDetailsViewController;
...
@property(readonly, nonatomic) CKUIStreamMessagesObserver *messagesObserver; // @synthesize messagesObserver=_messagesObserver;
@property(readonly, nonatomic) CKStream *stream; // @synthesize stream=_stream;
...
@property(nonatomic) __weak id <CKUIStreamViewControllerDelegate> delegate; // @synthesize delegate=_delegate;

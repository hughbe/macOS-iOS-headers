...
@class NSMutableDictionary, NSObject<OS_os_log>, NSString, OSActivityStream;

@interface CKDeviceManager : NSObject <OSDeviceDelegate>
{
    NSObject<OS_os_log> *_log;
    id <CKDeviceManagerDelegate> _delegate;
...
@property(nonatomic) __weak id <CKDeviceManagerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;

...
@class NSMutableArray, NSString, NSTokenField;

@interface CKTokenFieldController : NSObject <NSTokenFieldDelegate>
{
    BOOL _isBasicSearchEnabled;
    NSTokenField *_tokenField;
    id <CKTokenFieldControllerDelegate> _delegate;
...
@property(nonatomic) __weak id <CKTokenFieldControllerDelegate> delegate; // @synthesize delegate=_delegate;

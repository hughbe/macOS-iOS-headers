...
@interface CKActivity : CKEntity <NSCopying>
{
    BOOL _isDetached;
    NSString *_name;
...
@property(retain, nonatomic) NSNumber *parentActivityIdentifier; // @synthesize parentActivityIdentifier=_parentActivityIdentifier;
...
- (id)initWithIdentifier:(id)arg1 processImagePath:(id)arg2 libraryImagePath:(id)arg3 timestamp:(id)arg4 isVolatile:(BOOL)arg5 activityIdentifier:(id)arg6 name:(id)arg7;

...
@class NSCache, NSDictionary, NSObject<OS_dispatch_queue>, NSSet, NSString, SGBloomFilter, SGDatabaseJournal, SGDuetBridge, SGJournal, SGSpotlightContactsAdapter, SGSqliteDatabase, SGSuggestHistory;

...
struct CacheFrame {
    ...
    struct BufferNode *_field2;
    struct TextureNode *_field3;
};
...
struct MPSDevice {
    ...
    struct MPSGPUInfo _field8;
    struct MPSLibrary *_field9[25];
};

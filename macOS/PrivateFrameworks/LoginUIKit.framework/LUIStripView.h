...
@class NSImage, NSImageView, NSLayoutConstraint, NSMutableArray, NSMutableDictionary, NSMutableString, NSObject, NSTimer, NSView;
@protocol LUIStripViewDataSource, LUIStripViewDelegate, OS_dispatch_source;

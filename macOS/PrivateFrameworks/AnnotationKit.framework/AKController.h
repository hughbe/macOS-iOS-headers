...
@class AKActionController, AKAttributeController, AKCursorController_Mac, AKFormFeatureDetectorController, AKIntelligentSketchController, AKMainEventHandler, AKModelController, AKPageController, AKSignatureModelController, AKTextEditorController, AKToolController, AKToolbarViewController, AKUndoController, NSMapTable, NSMutableArray, NSView, NSWindow;

...
- (void)changeUserPassword:(unsigned int)arg1 oldPassword:(NSString *)arg2 newPassword:(NSString *)arg3 hint:(NSString *)arg4 completionBlock:(void (^)(BOOL))arg5;
- (void)changeUserToStandardAuth:(unsigned int)arg1 iCloudPassword:(NSString *)arg2 newPassword:(NSString *)arg3 hint:(NSString *)arg4 completionBlock:(void (^)(BOOL))arg5;

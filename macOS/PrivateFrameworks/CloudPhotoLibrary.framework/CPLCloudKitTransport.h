...
@class APSConnection, CDSession, CKContainer, CKDatabase, CKRecord, CKRecordZone, CPLEngineLibrary, NSDate, NSMapTable, NSMutableDictionary, NSMutableSet, NSObject<OS_dispatch_queue>, NSString;

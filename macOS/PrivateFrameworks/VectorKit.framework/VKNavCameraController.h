...
@class GEOMapRegion, GEORouteMatch, NSString, VKAttachedNavGestureCameraBehavior, VKDetachedNavGestureCameraBehavior, VKGestureCameraBehavior<VKNavGestureCameraBehavior>, VKMapCanvas, VKMapModel, VKNavContext, VKTimedAnimation;
...
- (CameraFrame_e4e5578c)calculateFramingCameraFrame;
...
- (CameraFrame_e4e5578c)calculateTrackingCameraFrame;

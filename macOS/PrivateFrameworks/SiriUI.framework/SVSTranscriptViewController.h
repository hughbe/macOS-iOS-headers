...
- (void)_updateKeylineForClumpView:(BOOL)arg1;
- (void)_hideTopKeyline;
- (void)_processHidingSnippetView:(id)arg1;
- (void)scrollViewDidScroll:(id)arg1;
- (void)_updateKeylinesForAnimation;
...
- (BOOL)_isTranscriptItemUserUtterance:(id)arg1;

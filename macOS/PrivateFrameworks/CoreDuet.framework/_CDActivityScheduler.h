...
@class CDAttribute, CDSession, NSDate, NSMutableArray, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSString, _CDActivity, _CDDateRange, _CDSystemMonitor;

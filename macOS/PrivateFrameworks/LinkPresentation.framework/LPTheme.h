...
@class LPCaptionBarStyle, LPImageViewStyle, LPSize, LPTapToLoadViewStyle, LPTextViewStyle, LPVideoViewStyle, NSColor;
...
@property(nonatomic) double squareishAspectRatioRange; // @synthesize squareishAspectRatioRange=_squareishAspectRatioRange;
@property(retain, nonatomic) LPSize *maximumIntrinsicSize; // @synthesize maximumIntrinsicSize=_maximumIntrinsicSize;

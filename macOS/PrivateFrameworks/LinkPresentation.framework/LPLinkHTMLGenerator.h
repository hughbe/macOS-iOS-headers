...
@class DOMDocument, DOMDocumentFragment, DOMElement, LPCSSResolver, LPCaptionBarPresentationProperties, LPHTMLLinkComponent, LPImage, LPLinkMetadata, LPMetadataProvider, LPTheme, LPVideo, NSColor, NSString, NSURL;

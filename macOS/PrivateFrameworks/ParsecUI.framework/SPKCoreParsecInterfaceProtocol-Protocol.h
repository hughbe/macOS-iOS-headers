...
- (void)getCEPDataWithReply:(void (^)(NSDictionary *))arg1;
...
- (void)resumeQuery:(long long)arg1 withReply:(void (^)(long long, NSString *, NSArray *, NSDictionary *, NSArray *, BOOL, double))arg2;

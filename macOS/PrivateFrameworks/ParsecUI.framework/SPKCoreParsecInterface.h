...
@class NSArray, NSDictionary, NSMutableArray, NSObject<OS_dispatch_queue>, NSString, PRSCoreParsecSearchSession;
...
@interface SPKCoreParsecInterface : NSObject <PRSSearchQueryHandler, SPKCoreParsecInterfaceProtocol, PRSBagFetchSuccessDelegate>
{
    ...
    PRSCoreParsecSearchSession *_searchSession;
...
@property(retain) PRSCoreParsecSearchSession *searchSession; // @synthesize searchSession=_searchSession;
...
- (void)isCurrentLocaleSupported:(id)arg1 withReply:(CDUnknownBlockType)arg2;

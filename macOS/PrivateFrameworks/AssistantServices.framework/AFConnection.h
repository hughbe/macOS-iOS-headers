...
@class NSArray, NSError, NSMutableDictionary, NSObject<OS_dispatch_group>, NSObject<OS_dispatch_source>, NSString, NSXPCConnection;
...
- (void)_startRequestWithInfo:(id)arg1 withEvent:(id)arg2;

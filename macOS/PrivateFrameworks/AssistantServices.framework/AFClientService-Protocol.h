...
@class AFApplicationInfo, AFAudioPlaybackRequest, AFMetrics, AFRequestInfo, AFSpeechRequestOptions, NSArray, NSData, NSDictionary, NSError, NSString, NSURL, SASPronunciationContext, SASetApplicationContext;

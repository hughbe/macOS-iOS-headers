...
@class NSDate, NSDictionary, NSHashTable, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSObject<OS_os_log>, NSProgress, NSString, PGManager, PHACoalescer, PHALibraryChangeBuffer, PHAPredicateValidator;
...
- (BOOL)shouldUnloadGraphOnCooldownOrLastPendingRequestCompletion;

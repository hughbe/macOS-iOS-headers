...
@class NSArray, NSBitmapImageRep, NSColor, NSData, NSDictionary, NSNumber, NSObject<NSSecureCoding>, NSSet, NSString;
...
- (void)bootstrap:(CDStruct_66551626)arg1 withReply:(void (^)(NSString *, struct))arg2;

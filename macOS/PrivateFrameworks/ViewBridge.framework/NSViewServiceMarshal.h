...
@class NSAccessibilityRemoteUIElement, NSColor, NSDictionary, NSLayoutConstraint, NSResponder, NSServiceViewController, NSString, NSVB_ViewServiceBehaviorProxy, NSViewBridge, NSXPCConnection, NSXPCInterface;
...
- (BOOL)shouldFauxSynchronouslyForwardPotentialCommandEquivalentToAuxService:(BOOL)arg1;
...
- (void)bootstrap:(CDStruct_66551626)arg1 withReply:(CDUnknownBlockType)arg2;
- (id)_bootstrap:(CDStruct_66551626)arg1 replyData:(CDStruct_f2cafd34 *)arg2;
...
- (void)hostWindowBecameKeyInActiveApp:(BOOL)arg1 isContentView:(BOOL)arg2;

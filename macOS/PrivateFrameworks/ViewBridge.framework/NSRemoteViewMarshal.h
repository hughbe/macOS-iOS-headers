...
@class CALayerHost, NSAccessibilityRemoteUIElement, NSDictionary, NSFakeServiceResponder, NSMutableArray, NSMutableSet, NSProxy<NSXPCProxyCreating>, NSRemoteView, NSSet, NSString, NSTrackingArea, NSVBAccessoryWindow, NSViewBridge, NSViewRemoteBridge, NSWindow, NSXPCConnection, NSXPCInterface, NSXPCListenerEndpoint;

...
@interface AppController : NSObject <NSApplicationDelegate, NSMenuDelegate, NSUserInterfaceValidations, FormTextStatusWatcherDelegate>
{
    ...
    WBSJavaScriptDialogManager *_javaScriptDialogManager;
...
@property(readonly, nonatomic) WBSJavaScriptDialogManager *javaScriptDialogManager;
...
- (void)emptyWebKit1Cache:(long long)arg1;
- (void)emptyCache:(long long)arg1;

...
@class AnnotatedBookmarksSidebarExpandedTableCellView, AnnotatedBookmarksSidebarTableView, BookmarkFolderPickerMenuController, NSArray, NSMenu, NSMutableArray, NSMutableSet, NSSearchField, NSString, NSTextField, NSTimer, NSView, SidebarScrollView, SidebarSearchField, WebBookmark, WebBookmarkList;
...
@interface AnnotatedBookmarksSidebarViewController : NSViewController <AnnotatedBookmarksSidebarTableCellViewDelegate, AnnotatedBookmarksSidebarExpandedTableCellViewDelegate, BookmarkFolderPickerMenuControllerDelegate, NSMenuDelegate, TableViewPlusDataSource, TableViewPlusDelegate, SidebarScrollViewAccessibilityDelegate, CustomKeyViewLoop, SidebarContentFiltering, SidebarContentViewController>
{
    ...
    BOOL _addFolderAfterNextReload;
    BOOL _bookmarksToDisplayContainsOnlyLists;
    BOOL _showLeafBookmarksOnly;
    BOOL _showCollapsedBookmarkLeaves;
    BOOL _isUpdatingForNewList;
    BOOL _suppressMetadataFetches;
    NSArray *_lastDraggedBookmarks;
    double _folderHierarchyScrollPositionBeforeTransition;
...
- (void)_updateIsShowingOnlyLists;
- (void)_appendFlatFolderHierarchyAndTopLevelLeavesForFolder:(id)arg1;
...
- (void)_faviconChanged:(id)arg1;
- (void)_setIconForCollapsedTableCellView:(id)arg1 withLeaf:(id)arg2;
...
- (void)_addFolderForSelectedRow;
- (void)_addFolderToCurrentBookmarkList;
- (id)_contextMenuBuilderForRow:(long long)arg1;
- (void)_updateCurrentLeafRows;
- (void)_saveShouldShowCollapsedBookmarksForBookmarkList:(id)arg1 shouldShow:(BOOL)arg2;
- (BOOL)_shouldShowCollapsedBookmarksForBookmarkList:(id)arg1;
...
@property(readonly, nonatomic) BOOL canAddBookmarkFolder;

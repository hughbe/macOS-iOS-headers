...
@class NSArray, NSLayoutConstraint, NSMutableSet, NSOutlineView, NSPopUpButton, NSScrollView, NSSegmentedControl, NSString, NSTableView, NSTextField, NSView, SegmentedControlWithDynamicWidth;

__attribute__((visibility("hidden")))
@interface ManagedPlugInsEditor : SheetWithTableController <ManagedPlugInsEditorPlugInCellViewDelegate, NSOutlineViewDataSource, OutlineViewPlusDelegate, NSTableViewDataSource, NSTableViewDelegate, NSMenuDelegate>
{
    NSArray *_plugIns;

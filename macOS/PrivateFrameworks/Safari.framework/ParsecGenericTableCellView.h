...
@interface ParsecGenericTableCellView : ParsecTableCellViewWithActionButton
{
    ...
    NSLayoutConstraint *_lastDescriptionLabelBaselineToImageViewBottomConstraint;
    ...
    NSLayoutConstraint *_auxiliaryViewTrailingConstraint;
...
@property(nonatomic) __weak NSLayoutConstraint *auxiliaryViewTrailingConstraint; // @synthesize auxiliaryViewTrailingConstraint=_auxiliaryViewTrailingConstraint;

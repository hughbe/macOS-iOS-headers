...
@class AutomaticReadingListContentProvider, BackgroundLoadController, BookmarksSidebarTitleTextView, BrowserTabGroupPersistentState, BrowserTabViewItem, BrowserTitlebarAccessoryViewController, BrowserWindow, BrowserWindowContentSplitViewController, BrowserWindowContentView, BrowserWindowPersistentState, ColoredRect, FavoritesBarView, FormTextStatusWatcher, NSArray, NSClipView, NSMapTable, NSMenu, NSMutableArray, NSMutableSet, NSString, NSTabView, NSTextView, NSTimer, NSTitlebarAccessoryViewController, NSURL, NSUUID, NSView, OneStepBookmarkingButtonController, OverlayStatusWindowController, PopupWindowUnifiedFieldViewController, ReadingListContentProvider, SidebarViewController, StatusMessage, TabBarView, ToolbarController, UnifiedField, UnifiedFieldEditor, VisualTabPickerViewController, WBSFluidProgressController;

__attribute__((visibility("hidden")))
@interface BrowserWindowController : WindowController <BackgroundLoadControllerDelegate, CAAnimationDelegate, FormTextStatusWatcherDelegate, NSTabViewDelegate, OverlayStatusWindowDelegate, TabDraggingWindowDestination, TabBarViewDelegate, ToolbarControllerDelegate, VisualTabPickerDelegate, BrowserWindowContentSplitViewControllerDelegate, WBSFluidProgressRocketEffectDelegate, BrowserContentLoaderDelegate, BrowserWindowDelegate, Command1Through9Receiver, ImageHopAnimationDelegate, NSMenuDelegate, NSSplitViewDelegate, ReopensAtLaunch, UnifiedFieldDelegate, WBSFluidProgressControllerWindowDelegate>
{
...
- (struct BrowserTab *)extensionEventTargetForBackgroundLoad:(id)arg1;
...
- (id)startBackgroundLoadWithURL:(id)arg1;

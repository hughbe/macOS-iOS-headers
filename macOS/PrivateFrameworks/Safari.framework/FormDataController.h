...
- (void)_findAllContactsWithSameFullNameAsContact:(id)arg1 andGetValuesForContactFormWithCompletionController:(struct FormAddressBookAutoFillCompletionController *)arg2 metadata:(id)arg3 inDomain:(id)arg4 contactLabel:(id)arg5;
- (void)showFlexibleContactsAutoFillUIForCompletionController:(struct FormAddressBookAutoFillCompletionController *)arg1 metadataProvider:(id)arg2 contactLabel:(id)arg3;

...
@class NSCountedSet, NSMutableDictionary, NSNib, ParsecTableCellView;
...
@interface UnifiedFieldCompletionListCellViewReuseManager : NSObject
{
    ...
    ParsecTableCellView *_mostRecentlyUsedParsecCellView;
}

+ (id)sharedManager;
@property(readonly, nonatomic) ParsecTableCellView *mostRecentlyUsedParsecCellView; // @synthesize mostRecentlyUsedParsecCellView=_mostRecentlyUsedParsecCellView;
- (void).cxx_destruct;

...
@property(readonly, copy, nonatomic) NSString *userVisibleURLString; // @synthesize userVisibleURLString=_threadUnsafeUserVisibleURLString;
- (void)setURLStringWithoutNotifications:(id)arg1;

...
@class BackgroundLoad, BookmarksView, BookmarksViewController, BrowserTabPersistentState, BrowserTabViewItem, BrowserWindowController, ContinuousReadingListPageItem, ContinuousReadingListViewController, DefaultBrowserBanner, JavaScriptDialogSuppressionManager, JavaScriptDialogViewController, NSArray, NSDictionary, NSHashTable, NSMutableArray, NSString, NSTimer, NSURL, NSView, NSWindow, PrivateBrowsingExplanationBanner, PromptToEnablePlugInBanner, ReadingListItem, ResponsiveDesignViewController, SearchableWKView, StartPageViewController, StatusMessage, TabContentView, UnresponsiveWebProcessHandler, WBSFluidProgressState, WBSHistoryVisit, WBSMultiRoundAutoFillManager, WBSSameDocumentNavigationToHistoryVisitCorrelator, WebClipBanner, WebCrashBanner;

__attribute__((visibility("hidden")))
@interface BrowserContentViewControllerObjCAdapter : WebContentController <AuthenticationSheetRequestDelegate, DimmingViewDelegate, ReaderActivationDelegate, ReaderAvailabilityDelegate, WBSFluidProgressStateSource>
{
    ...
    JavaScriptDialogViewController *_javaScriptDialogViewController;
    ...
    BOOL _skipAnimationsWhenDismissingPendingJSDialogs;
    ...
    NSURL *_destinationURLForNavigationFromParentTab;
...
@property(nonatomic) BOOL skipAnimationsWhenDismissingPendingJSDialogs; // @synthesize skipAnimationsWhenDismissingPendingJSDialogs=_skipAnimationsWhenDismissingPendingJSDialogs;
...
@property(readonly, nonatomic) NSURL *destinationURLForNavigationFromParentTab; // @synthesize destinationURLForNavigationFromParentTab=_destinationURLForNavigationFromParentTab;
...
@property(readonly, nonatomic) JavaScriptDialogViewController *javaScriptDialogViewController;
@property(readonly, nonatomic) BOOL isUnresponsiveDueToJavaScriptDialogRunningInProcess;
@property(readonly, nonatomic, getter=isShowingJavaScriptDialog) BOOL showingJavaScriptDialog;
...
- (void)_presentJavaScriptDialogWithMode:(long long)arg1 message:(id)arg2 defaultResponse:(id)arg3 origin:(const struct SecurityOrigin *)arg4 completionHandler:(id)arg5;
- (void)_didDismissJavaScriptDialogs;
...
- (void)setUpSpawnedTabFromParentTab:(id)arg1 parentTabSnapshot:(id)arg2 snapshotImageScale:(double)arg3 destinationURL:(id)arg4;
...
- (BOOL)handleNavigationToURLIfFirstNavigationInTabCreatedFromParentTab:(id)arg1;
- (void)handleCommitLoadForSpawnedTabParentURL;
...
- (void)confirmReloadingWithEditedFormText;
...
- (id)startBackgroundNavigationWithURL:(id)arg1 shouldGoBackAfterBackgroundNavigationIsCommitted:(BOOL)arg2;

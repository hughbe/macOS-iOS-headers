...
@class PBUnknownFields, _INPBDouble, _INPBInteger, _INPBIntentMetadata;
...
+ (id)options;
@property(retain, nonatomic) _INPBDouble *temperature; // @synthesize temperature=_temperature;

...
#import "SCNResourceManager.h"

@class MTKTextureLoader, NSMutableArray, NSObject<OS_dispatch_semaphore>, NSString, SCNMTLBufferAllocator, SCNMTLShadableKey, SCNMetalLibraryManager;
...
@interface SCNMetalResourceManager : NSObject <SCNResourceManager>
{
    ...
    CDStruct_65a15318 _availableIrradianceTextures;
    CDStruct_65a15318 _availableRadianceTextures;
    CDStruct_65a15318 _availableImages;
    CDStruct_65a15318 _availableImageProxy;
    CDStruct_65a15318 _availableSamplers;
    CDStruct_65a15318 _availableBuffers;
    CDStruct_65a15318 _availableMeshes;
    CDStruct_65a15318 _availableMeshSources;
    CDStruct_65a15318 _availableMeshElements;
    CDStruct_65a15318 _availableRasterizerStates;
    CDStruct_65a15318 _availableMorphs;
    CDStruct_65a15318 _availableComputePipelines;
    CDStruct_65a15318 _availableShadables;

...
@interface CFPrefsDaemon : NSObject
{
    ...
    BOOL _testMode;
    CDUnion_9adbcd3f *_shmem;
}

- (id)listener;
- (void)sendEachAgent:(id)arg1;
- (void)inGroup:(id)arg1 withEachAgentConnection:(CDUnknownBlockType)arg2;
- (void)removeAgentConnectionsWithUserName:(const char *)arg1;
- (void)withAgentDictionary:(CDUnknownBlockType)arg1;
- (void)checkIn;
- (void)getShmemName:(char *)arg1 bufLen:(unsigned long long)arg2;
- (unsigned int)userID;
- (CDUnion_9adbcd3f *)shmem;

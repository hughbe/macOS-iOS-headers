...
@class NSArray, NSColor, NSData, NSMenu, NSString, NSTouchBar, NSURL, WKBackForwardList, WKBrowsingContextHandle, WKWebViewConfiguration, _WKFrameHandle, _WKInspector, _WKSessionState, _WKThumbnailView;
@protocol WKHistoryDelegatePrivate, WKNavigationDelegate, WKUIDelegate, _WKDiagnosticLoggingDelegate, _WKFindDelegate, _WKFullscreenDelegate, _WKIconLoadingDelegate, _WKInputDelegate, _WKTextManipulationDelegate;

@interface WKWebView : NSView <NSTextInputClient, NSTextInputClient_Async, NSTouchBarProvider, NSFilePromiseProviderDelegate, NSDraggingSource, NSUserInterfaceValidations, WebViewImplDelegate, WKShareSheetDelegate>
{

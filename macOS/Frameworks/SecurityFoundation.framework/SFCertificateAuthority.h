...
- (id)createSelfSignedCertificateWithPublicKey:(struct __SecKey *)arg1 privateKey:(struct __SecKey *)arg2 inputParms:(id)arg3 error:(id *)arg4;
- (id)_publicKeyHash;
...
- (struct __SecKey *)_copyPrivateKeyFromPublicKeyHash:(id)arg1 inKeychainOrArray:(void *)arg2;
...
- (BOOL)createWithPublicKey:(struct __SecKey *)arg1 privateKey:(struct __SecKey *)arg2 keychain:(struct __SecKeychain *)arg3 authenticator:(id)arg4 signer:(struct __SecIdentity *)arg5 inputParms:(id)arg6 error:(id *)arg7;
- (BOOL)_createWithPublicKey:(struct __SecKey *)arg1 privateKey:(struct __SecKey *)arg2 keychain:(struct __SecKeychain *)arg3 authenticator:(id)arg4 signer:(struct __SecIdentity *)arg5 ca:(id)arg6 inputParms:(id)arg7 error:(id *)arg8;
...
- (int)_createCert:(struct __SecKey *)arg1 privKey:(struct __SecKey *)arg2 keychain:(struct __SecKeychain *)arg3;

...
struct TBaseFont {
    ...
    struct array<std::__1::unordered_map<unsigned int, OTL::Lookup, std::__1::hash<unsigned int>, std::__1::equal_to<unsigned int>, std::__1::allocator<std::__1::pair<const unsigned int, OTL::Lookup>>>, 2> _field36;
    struct atomic<unsigned short> _field37;
    struct TUnfairLock _field38;
    struct TInlineVector<std::__1::unique_ptr<unsigned short const[], std::__1::default_delete<unsigned short const[]>>, 1> _field39;
    struct TInlineVector<std::__1::unique_ptr<unsigned short const[], std::__1::default_delete<unsigned short const[]>>, 4> _field40;
    struct array<TCFRef<__CFDictionary *>, 7> _field41;
};

...
@class GEOAddress, GEOFeatureStyleAttributes, GEOMapItemDetourInfo, GEOMapRegion, GEOPDBusinessClaim, GEOPDFlyover, GEOPlace, MKMapItemMetadata, MKPlacemark, NSArray, NSData, NSString, NSTimeZone, NSURL, _MKMapItemAttribution, _MKMapItemPhotosAttribution, _MKMapItemPlaceAttribution, _MKMapItemReviewsAttribution, _MKPlaceReservationInfo;
...
+ (id)mapItemWithSerializedPlaceData:(id)arg1 serializedDetourInfo:(id)arg2;

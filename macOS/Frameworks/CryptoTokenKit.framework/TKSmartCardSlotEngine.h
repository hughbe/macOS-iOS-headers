...
@class NSArray, NSHashTable, NSMapTable, NSMutableArray, NSObject<OS_dispatch_queue>, NSString, NSXPCConnection, NSXPCListener, TKPowerMonitor, TKSmartCardATR, TKSmartCardSessionEngine;

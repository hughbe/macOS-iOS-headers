...
@class MTLIOAccelBuffer, MTLIOAccelDevice, MTLIOAccelDevice<MTLDevice>, MTLIOAccelDeviceShmem, MTLIOAccelDeviceShmemPool, MTLIOAccelPooledResource, MTLIOAccelResourcePool, MTLRenderPassColorAttachmentDescriptorArrayInternal, MTLRenderPipelineColorAttachmentDescriptorArrayInternal, MTLResourceAllocationInfo, MTLResourceList, MTLStencilDescriptorInternal, MTLVertexDescriptorInternal, NSString;
...
struct MTLVertexAttributeFlags {
    union {
        struct {
            unsigned int :1;
            unsigned int :1;

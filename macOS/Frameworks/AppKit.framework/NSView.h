...
@class CALayer, CIFilter, NSAppearance, NSArray, NSBezierPath, NSColor, NSColorSpace, NSDictionary, NSLayoutRect, NSMenuItem, NSMutableArray, NSMutableSet, NSPressureConfiguration, NSScrollView, NSShadow, NSString, NSSurface, NSTextInputContext, NSURL, NSViewController, NSWindow, _NSViewAuxiliary;
...
- (BOOL)_userInterfaceLayoutDirectionIsSet;

...
@class AVChapterMenuController, AVOutputDeviceMenuController, AVPlayerController, AVPlayerControllerTimeResolver, AVPlayerView, AVSlowMotionSlider, NSButton, NSMenu, NSString, NSTextField, NSView;

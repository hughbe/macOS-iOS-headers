...
@class ABCardViewSaveHelper, ABCardViewStyleProvider, ABCardViewUndoableDataSource, ABCommandExecutor, ABPerson, AKCardViewDataSource, AKCardViewDataSourceFactory, CNContact, CNContactCardViewControlContext, CNContactCardViewControllerABPersonViewMediator, CNContactCardViewControllerDataSourceDelegate, CNContactCardViewControllerWidgetProviderDelegate, CNContactCardWidgetProvider, CNUIMeContactMonitor, CNUIUserActionListDataSource, NSArray, NSMutableDictionary, NSSet, NSStackView, NSString, NSTextField, NSUndoManager;

@interface CNContactCardViewController : NSViewController <CNContactDetailsViewControllerDelegate, CNContactNameViewControllerDelegate, AKCardViewDataSourceSupport, ABCardViewDelegate, CNAvatarViewDelegate, ABShareKitTransitionProvider>
{
    BOOL _editable;
    BOOL _selectable;
    BOOL _isSaving;
...
@property(readonly, nonatomic) struct CGSize preferredMinimumSize;

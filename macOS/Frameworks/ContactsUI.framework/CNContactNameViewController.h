...
@class ABNameView, AKCardViewDataSource, CNContact, NSArray, NSString, NSTextField, NSView<ABNameView>;

@interface CNContactNameViewController : NSViewController <ABNameViewDelegate, CNContactCardWidget>
{
    CNContact *_contact;

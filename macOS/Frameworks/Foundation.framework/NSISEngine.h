...
@class NSHashTable, NSISVariable, NSISVariableChangeTracker, NSMapTable, NSMutableArray, NSMutableDictionary, NSMutableSet, NSObject<NSObservable>, NSString, NSThread;

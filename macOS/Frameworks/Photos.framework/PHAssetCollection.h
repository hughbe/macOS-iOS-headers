...
- (id)initTransientWithQuery:(id)arg1 title:(id)arg2 identifier:(id)arg3;
- (id)initTransientWithFetchResult:(id)arg1 title:(id)arg2 identifier:(id)arg3;
- (id)initTransientWithAssets:(id)arg1 title:(id)arg2 identifier:(id)arg3 photoLibrary:(id)arg4;

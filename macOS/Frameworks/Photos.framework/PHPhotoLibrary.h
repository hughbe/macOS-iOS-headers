...
- (void)commitTransaction:(CDUnknownBlockType)arg1;
...
- (void)requestAnalysisJobConstraints:(CDUnknownBlockType)arg1;
...
- (id)fetchFaceGroupsForPerson:(id)arg1 type:(long long)arg2 options:(id)arg3;
...
- (id)faceGroupCreationRequestWithType:(long long)arg1;
